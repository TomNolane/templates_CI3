				...
				<div class="row">
					<div class=" kri1 col-lg-4  col-md-6 col-sm-6 col-xs-12">
						<div class="service-item services-third">
							<img class="imggg1" src="/templates/test/assets/img/img1.png" alt="img1.png">
						</div>
...
анкету внеся корректные данные</p>
						...
						<img src="/templates/test/assets/img/index/arrow.png" class="service-arrow" alt="arrow.png">
					</div> 


						<div class=" kri2 col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<div class="service-item services-third">
							<img class="imggg1" src="/templates/test/assets/img/img3.png" alt="img3.png">
						</div>
						<div class="service-text">
...
одобренным займом.</p>
					...
					<div class=" kri3 col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<div class="service-item services-third">
							<img class="imggg1" src="/templates/test/assets/img/img4.png" alt="img4.png">
						</div>
						<div class="service-text">
