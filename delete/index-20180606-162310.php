        ...
        <div class="row">
            <div class="col-md-3">
                <div class="ex-int-block ex-first">
                    <img src="/templates/test/assets/img/img1.png" alt="img1.png">
                    <h3>7 минут<br>
                        на одобрение</h3>
            ...
            <div class="col-md-3">
                <div class="ex-int-block ex-second">
                    <img src="/templates/test/assets/img/img2.png" alt="img2.png">
            ...
            <div class="col-md-3">
                <div class="ex-int-block ex-third">
                    <img src="/templates/test/assets/img/img3.png" alt="img3.png">
                    <h3>Работаем<br>
                        24 часа в сутки</h3>
            ...
            <div class="col-md-3">
                <div class="ex-int-block ex-fourth">
                    <img src="/templates/test/assets/img/img4.png" alt="img4.png">
                    <h3>Не требуем<br>
