...
<div class="hidden-xs hidden-sm" style="margin-top: 50px;"></div>
     <div class="container new_style" style="width: 100%;">
        <div class="row">            
            <div class="col-md-4 text-left arrow-down hidden-sm hidden-xs"></div>
            <div class="col-md-8 text-left arrow-down" style="color: #000; font-weight:bold;">
            ...
            <div class="col-md-4 text-left arrow-down hidden-sm hidden-xs">
                <img src="/templates/dengimo/img/man2.png" style="max-height: 400px;">
            </div>
            <div class="col-md-8 text-left arrow-down" style="color: #000; font-weight:bold;">
                <br/><br/>
                ...
                <br/><br/><br/><br/>
                <a href="" target="_blank" class="btn btn-xl btn-success" id="email_confirm" style="margin: 0px; padding: 12px 20px;" style="font-size: 20px;"> Подтвердить почту </a>
                <a href="/lk" class="btn btn-default" style="margin: 0px;  padding: 12px 20px;" style="font-size: 20px; color: #ccc;"> Позже </a>
                <br/><br/>
