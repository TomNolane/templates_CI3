...
if ($this->uri->segment(1) == 'faq') echo '<img src="/templates/test/assets/img/faq.png" alt="rublimo.ru">';
elseif ($this->uri->segment(1) == 'zaim-card') echo '<img src="/templates/test/assets/img/zaim/card.png" alt="rublimo.ru">';
elseif ($this->uri->segment(1) == 'zaim-qiwi') echo '<img src="/templates/test/assets/img/zaim/qiwi.png" alt="rublimo.ru">';
elseif ($this->uri->segment(1) == 'zaim-yandex') echo '<img src="/templates/test/assets/img/zaim/yandex.png" alt="rublimo.ru">';
elseif ($this->uri->segment(1) == 'zaim-contact') echo '<img src="/templates/test/assets/img/zaim/contact.png" alt="rublimo.ru">';
elseif ($this->uri->segment(1) == 'zaim-bank') echo '<img src="/templates/test/assets/img/zaim/bank.png" alt="rublimo.ru">';
