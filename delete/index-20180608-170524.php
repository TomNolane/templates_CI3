                    ...
                    <div class="ex-adv-bg">
                        <div class="row">
                            <div class="col-md-4 ex-line-right ">
                                <div class="row ex-pad-not">
                                    <div class="ex-adv-block ex-line-bottom">
                                        <img src="/templates/test/assets/img/icon1.png" alt="icon1.png">
                            ...
                            <div class="col-md-4 ex-line-right ">
                                <div class="row">
                                    <div class="ex-adv-block ex-line-bottom">
                                        <img src="/templates/test/assets/img/icon2.png" alt="icon2.png">
                            ...
                            <div class="col-md-4 ">
                                <div class="row ex-pad-not-right">
                                    <div class="ex-adv-block ex-line-bottom">
                                        <img src="/templates/test/assets/img/icon3.png" alt="icon3.png">
                            ...
                            <div class="col-md-4 ex-line-right">
                                <div class="row">
                                    <div class="ex-adv-block">
                                        <img src="/templates/test/assets/img/icon4.png" alt="icon4.png">
                            ...
                            <div class="col-md-4 ex-line-right">
                                <div class="row">
                                    <div class="ex-adv-block">
                                        <img src="/templates/test/assets/img/icon5.png" alt="icon5.png">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="ex-adv-block">
                                        <img src="/templates/test/assets/img/icon6.png" alt="icon6.png">
