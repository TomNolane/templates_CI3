        ...
        <div class="triggers hidden-xs hidden-sm">
            <div class="row">
                <div class="col-sm-2 col-sm-offset-2">
                    <img src="/templates/test/assets/img/form/t1.png" alt="t1.png">
                    <p>Ваши персональные данные надёжно защищены</p>
                </div>
                <div class="col-sm-2">
                    <img src="/templates/test/assets/img/form/t2.png" alt="t2.png">
                    <p>Удобное получение денег</p>
                </div>
                <div class="col-sm-2">
                    <img src="/templates/test/assets/img/form/t3.png" alt="t3.png">
                    <p>Принимаем заявки с любой кредитной историей</p>
                </div>
                <div class="col-sm-2">
                    <img src="/templates/test/assets/img/form/t4.png" alt="t4.png">
