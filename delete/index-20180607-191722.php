                                        ...
                                        <div class="row ">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 col-xs-6 ">
                                                        <div class="ex-icon-bg">
                                                            <img src="/templates/test/assets/img/icons/1.png" alt="1.png">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-4 ex-mb ">
                                                <div class="row">
                                                    <div class="col-md-4 col-xs-6">
                                                        <div class="ex-icon-bg">
                                                            <img src="/templates/test/assets/img/icons/2.png" alt="2.png">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8 col-xs-6">
                                                        <div class="ex-crumbs">
                                            ...
                                            <div class="col-md-4 ex-mb">
                                                <div class="row">
                                                    <div class="col-md-4 col-xs-6 ">
                                                        <div class="ex-icon-bg">
                                                            <img src="/templates/test/assets/img/icons/3.png" alt="3.png">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8 col-xs-6 ">
                                                        <div class="ex-crumbs">
            ...
            <div class="ex-rus-map">
                <div class="container">
                        ...
                        <div class="row">
                                ...
                                <div class="ex-steps ex-fl">
                                    ...
                                    <div class="ex-work-block ">
                                        <div class="ex-number-img">
                                            <img src="/templates/test/assets/img/1.png" alt="1.png">
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="ex-steps ex-fl">
                                    ...
                                    <div class="ex-work-block">
                                        <div class="ex-number-img">
                                            <img src="/templates/test/assets/img/2.png" alt="2.png">
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="ex-steps ex-fl">
                                    ...
                                    <div class="ex-work-block ">
                                        <div class="ex-number-img">
                                            <img src="/templates/test/assets/img/3.png" alt="3.png">
                                        </div>
                    ...
                    <div class="ex-pin-block ex-pin-active ex-first">
                        <img src="/templates/test/assets/img/pin.svg" alt="pin.svg">
                        <div class="ex-wr">
                            <span>г. Москва,</span>
                            <p>100 000 рублей</p>
                        </div>
