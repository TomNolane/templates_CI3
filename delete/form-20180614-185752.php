            ...
            <div class="col-md-12 col-xs-12" id="to_scroll">
                ...
                <div class="col-md-2 hidden-sm hidden-xs icon">
                    <div class="text-center icon-text">
                        <img src="/templates/test/assets/img/form/1.png" alt="Ваши персональные данные надёжно защищены" class="img-rounded">
                        <span>Ваши персональные данные надежно защищены</span>
                    </div>
                    <div class="text-center icon-text">
                        <img src="/templates/test/assets/img/form/2.png" alt="Удобное получение денег" class="img-rounded">
                        <span>Удобное получение денег</span>
                    </div>
                    <div class="text-center icon-text">
                        <img src="/templates/test/assets/img/form/3.png" alt="Принимаем заявки с любой кредитной историей" class="img-rounded">
                        <span>Круглосуточная работа</span>
                    </div>
                    <div class="text-center icon-text">
                        <img src="/templates/test/assets/img/form/4.png" alt="Деньги Вас ждут прямо сейчас" class="img-rounded">
