                        ...
                        <div class="ex-wrapper">
                            <div class="row">
                                ...
                                <div class="col-md-3 hidden-xs hidden-sm">
                                    <ul class="ex-payment">
                                        <li>
                                           <img src="/templates/test/assets/img/visa.png" alt="visa.png">
                                        </li>
                                        <li>
                                            <img src="/templates/test/assets/img/mastercard.png" alt="mastercard.png">
                                        </li>
                                        <li>
                                            <img src="/templates/test/assets/img/yandex.png" alt="yandex.png">
                                        </li>
                                        <li>
                                        <img src="/templates/test/assets/img/qiwi.png" alt="qiwi.png">
                                        </li>
                                        <li>
                                        <img src="/templates/test/assets/img/contact.png" alt="contact.png">
                                        </li>
                                        <li>
                                        <img src="/templates/test/assets/img/bank.png" alt="bank.png">
                                        </li>
                                    </ul>
                                </div>
                                </a>
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="ex-get-money">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="ex-img-place">
                                    <img src="/templates/test/assets/img/web.png" alt="web.png">
                                </div>
                            </div>
                        ...
                        <div class="ex-steps-block">
                            <img src="/templates/test/assets/img/01.png" alt="01.png">
                            <span>шаг</span>
                            <i></i>
                        </div>
                    </div>
                    <div class="ex-get-money">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="ex-img-place">
                                    <img src="/templates/test/assets/img/web2.png" alt="web2.png">
                                </div>
                            </div>
                            <div class="col-md-9 ex-text-place">
                        ...
                        <div class="ex-steps-block">
                            <img src="/templates/test/assets/img/02.png" alt="02.png">
                            <span>шаг</span>
                            <i></i>
                        </div>
                    </div>
                    <div class="ex-get-money">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="ex-img-place">
                                    <img src="/templates/test/assets/img/web3.png" alt="web3.png">
                                </div>
                            </div>
                            <div class="col-md-9 ex-text-place">
                        ...
                        <div class="ex-steps-block">
                            <img src="/templates/test/assets/img/03.png" alt="03.png">
                            <span>шаг</span>
                            <i></i>
                        </div>
                    </div>
