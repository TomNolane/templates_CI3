                        ...
                        <div class="panel-group" id="accordion">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">
                                            Dlaczego muszę podawać dane osobowe i czy to jest dla mnie bezpieczne?
                                            <i class="ex-plus"></i>
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapse2" class="panel-collapse collapse">
                                    <div class="card-body">
                                       <p> Dane osobowe użytkowników są przetwarzane przez Microdengi zgodnie z przepisami
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse5">
                                            Jaką kwotę mogę uzyskać i jaki jest okres spłaty pożyczki?
                                            <i class="ex-plus"></i>
                                        </a>
                                    </h4>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div id="collapse6" class="panel-collapse collapse">
                                    <div class="card-body">
                                        <p>Żeby złożyć wniosek należy mieć pod ręką dokument tożsamości.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">
                                        ...
                                        <a data-toggle="collapse" data-parent="#accordion2" href="#collapse10">
                                            <i class="ex-plus"></i>
                                            Porejestracji na stronie w jaki sposób można uzyskać pożyczkę?
                                        </a>

                                    </h4>
                                </div>
                                <div id="collapse10" class="panel-collapse collapse show">
                                    <div class="card-body">no text</div>
                                </div>
                            </div>
                        </div>
                    </div>
