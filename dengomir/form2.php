        ...
        <div class="row">
            <div class="">
                <div class="form-group has-feedback">
                    <label class="control-label col-md-3" for="passport">Серия и номер паспорта
                    </label>
                    <div class="col-md-9">
                ...
                <div class="form-group has-feedback">
                    <label class="control-label col-md-3" for="passport_code">Код подразделения
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
                ...
                <div class="form-group has-feedback">
                    <label class="control-label col-md-3" for="birthplace">Место рождения
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
                ...
                <div class="form-group has-feedback">
                    <label class="control-label col-md-3" for="city">Населённый пункт
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
                ...
                <div class="form-group has-feedback">
                    <label class="control-label col-md-3" for="building">Номер дома
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
                ...
                <div class="form-group has-feedback">
                    <label class="control-label col-md-3" for="reg_type">Тип регистрации
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper ex-arrow">
