    ...
    <div class="ex-form-wrap">
        <div class="row">
            <div class="">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3" for="work_salary">Зарплата(в рублях)
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3" for="work_city">Место работы (город)
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3" for="work_house" >№ дома работы
                    </label>
                    <div class="col-md-9">
                        <div class="ex-wrapper">
