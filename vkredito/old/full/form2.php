<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		<input type="tel" class="form-control ec tip" id="passport" name="passport" placeholder="Номер и серия паспорта" title="Пожалуйста, введите серию и номер паспорта"
		...
		<p class="help-block2">Нужно указать серию и номер паспорта</p>
		<p class="text-muted helpblock">Пример: 4510 842088</p>
	</div>
</div>
...
<div class="form-group" style="display: none;">
	...
	<div class="col-sm-4">
		<input type="tel" class="form-control ec" id="passport-s" name="passport_s" placeholder="0000" title="Серия паспорта" data-validation="number"
		        data-validation-allowing="range[1;9999]" data-validation-error-msg="Пожалуйста, введите серию паспорта" required>
	</div>
	<div class="col-sm-4">
		<input type="tel" class="form-control ec" id="passport-n" name="passport_n" placeholder="000000" title="Номер паспорта" data-validation="number"
		        data-validation-allowing="range[1;999999]" data-validation-error-msg="Пожалуйста, введите номер паспорта" required>
	</div>
</div>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		...
		<p class="help-block2">Нужно указать дату выдачи паспорта</p>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		...
		<p class="help-block2">Нужно указать код подразделения</p>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		<input type="text" class="form-control ec tip" name="passport_who" id="passport_who" placeholder="Кем выдан паспорт" title="Пожалуйста, укажите кем выдан паспорт"
		        data-sanitize="capitalize" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\-\.\№\(\)\s\d]+$" data-validation-error-msg="Пожалуйста, укажите, кем выдан паспорт"
		        required>
		<span id="passport_whostatus" class="glyphicon form-control-feedback" aria-hidden="true"></span>
		<p class="help-block2">Нужно указать кем выдан паспорт</p>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		<input type="text" class="form-control ec tip" name="birthplace" id="birthplace" placeholder="Место рождения" title="Пожалуйста, ваше место рождения"
		        data-sanitize="capitalize" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\d\s\-\,\#\.\+\(\)]+$" data-validation-error-msg="Пожалуйста, укажите место рождения"
		        required>
		<span id="birthplacestatus" class="glyphicon form-control-feedback" aria-hidden="true"></span>
		<p class="help-block2">Нужно указать место рождения</p>
		<p class="text-muted helpblock">Пример: г. Барнаул</p>
	</div>
</div>

<div class="clearfix">&nbsp;</div>
<div class="form-group">
	<label class="col-sm-8 col-sm-offset-4">Место жительства</label>
</div>
<div class="clearfix">&nbsp;</div>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		...
		<p class="help-block2">Нужно указать город в котором живете</p>
		<p class="text-muted helpblock">Пример: г. Москва</p>
	</div>
</div>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		...
		<p class="help-block2">Нужно указать название улицы</p>
		<p class="text-muted helpblock">Пример: ул. Тверская</p>
	</div>
</div>
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		...
		<p class="help-block2">Нужно указать номер дома</p>
		<p class="text-muted helpblock">Пример: 9а</p>
	</div>
</div>
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		...
		<p class="text-muted helpblock">Пример: 1</p>
	</div>
</div>
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		...
		<p class="help-block2">Нужно указать номер квартиры</p>
		<p class="text-muted helpblock">Пример: 41</p>
	</div>
</div>
<div class="clearfix">&nbsp;</div>
<div class="form-group">
	<label class="col-sm-8 col-sm-offset-4">Регистрация (прописка)</label>
</div>
<div class="clearfix">&nbsp;</div>
<div class="form-group">
