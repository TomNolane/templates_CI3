...
<div class="form-group has-feedback">
    ...
    <div class="col-sm-8">
        <div class="shadow">
            ...
            <p class="help-block2">Нужно указать вашу должность</p>
            <p class="text-muted helpblock">Пример: электромонер</p>
        </div>
    </div>
</div>
<div class="form-group has-feedback">
    ...
    <div class="col-sm-8">
        <div class="shadow">
            ...
            <p class="help-block2">Нужно указать номер рабочего телефона</p>
            <p class="text-muted helpblock">Пример: +7(977)747-48-48</p>
        </div>
    </div>
</div>
<div class="form-group has-feedback">
    ...
    <div class="col-sm-8">
        <div class="shadow">
            ...
            <p class="help-block2">Нужно указать стаж работы</p>
...
<div class="form-group has-feedback">
    ...
    <div class="col-sm-8">
        <div class="shadow">
            ...
            <p class="help-block2">Нужно указать размер зарплаты</p>
            <p class="text-muted helpblock">Пример: 25 000</p>
        </div>
    </div>
</div>
...
<div class="form-group has-feedback">
    ...
    <div class="col-sm-8">
        <div class="shadow">
            ...
            <p class="help-block2">Нужно указать населенный пункт работы</p>
...
<div class="form-group has-feedback">
    ...
    <div class="col-sm-8">
        <div class="shadow">
            ...
            <p class="help-block2">Нужно указать улицу работы</p>
...
<div class="form-group has-feedback">
    ...
    <div class="col-sm-8">
        <div class="shadow">
            ...
            <p class="help-block2">Нужно указать номер дома работы</p>
            <p class="text-muted helpblock">Пример: 17в</p>
        </div>
    </div>
</div>
<div class="form-group has-feedback" style="display:none;">
    ...
    <div class="col-sm-8">
        <div class="shadow">
            ...
            <p class="text-muted helpblock">Пример: 2</p>
        </div>
    </div>
</div>
<div class="form-group has-feedback">
    ...
    <div class="col-sm-8">
        <div class="shadow">
            ...
            <p class="text-muted helpblock">Пример: 105</p>
        </div>
    </div>
</div>
<div class="clearfix">&nbsp;</div>