				...
				<form id="anketa" action="/form" method="post">
					...
					<div class="sliders">
                                            <div class="form-slider green">
                                                    <div class="col-md-12"><input type="text" class="amount" id="amount" name="amount" value="6000" /></div>
                                                    <div class="clearfix"></div>
                                            </div>
                                            <div class="form-slider green" style="display: none;">
                                                    <div class="col-md-12"><input type="text" class="period" id="period" name="period" value="10" /></div>
                                                    <div class="clearfix"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="col-md-3 col-sm-4 col-xs-4 form-label-2 summary hidden-sm hidden-xs"><div>Вы берете:</div><span class="current_amount">6 000</span> Р</div>
                                            <div class="col-md-3 col-sm-4 col-xs-4 form-label-2 summary"><div><span class="hidden-xs">Процентная</span> ставка:</div><span class="current_percent">1.3</span> % <span class="hidden-xs">в день</span></div>
                                            <div class="col-md-3 col-sm-4 col-xs-4 form-label-2 summary"><div>Срок:</div><span class="srok" style="font-size: 12px;">от 61 дня</span></span></div>
                                            <div class="col-md-3 col-sm-4 col-xs-4 form-label-2 summary"><div>Нужно вернуть:</div><span class="current_summ">6 780</span> Р</span></div>
    ...
    <div class="container">
            ...
            <div class="row">
                    <div class="col-md-2 col-sm-2 col-md-offset-1 col-sm-offset-1">
                            <div class="algo-item"><a href="/form"><img src="/templates/vkredito/img/steps/1.png"></a></div>
                            <p>Зайдите на сайт</p>
                    </div>
                    <div class="col-md-2 col-sm-2 inner">
                    </div>    
                    <div class="col-md-2 col-sm-2 text-center">
                            <div class="algo-item"><a href="/form"><img src="/templates/vkredito/img/steps/2.png"></a></div>
                            <p>Заполните короткую анкету</p>
                    </div>
                    <div class="col-md-2 col-sm-2 inner">
                    </div>                
                    <div class="col-md-2 col-sm-2 text-center">
                            <div class="algo-item"><a href="/form"><img src="/templates/vkredito/img/steps/3.png"></a></div>
                            <p>Получите деньги</p>
                    </div>
            </div>
    </div>
	...
	<div class="row">
		<div class="col-xs-12 text-center">
			<h2>Срочные онлайн займы - мгновенное решение ваших проблем</h2>
                        <p>Хотите получить кредит здесь и сейчас? Нет времени ждать? Вам поможет сервис Vkredito. С нашей помощью вы быстро найдете предложение с самыми выгодными условиями кредитования и получите нужную сумму.</p>
                        
                        <p>Онлайн займы - это самое эффективное решение финансовых проблем. Больше не нужно собирать десятки справок, тратить время на посещение банка и ждать тщательного анализа вашей благонадежности банковскими служащими. Никаких поручителей и субъективных ошибочных решений. Вы честно и справедливо получите свой кредит после регистрации на сайте и заполнения короткой анкеты. </p>
                        
                        <p>Если столкнулись со сложной ситуацией и срочно нужны деньги, обращайтесь сразу Vkredito. Тут вам окажут своевременную помощь.</p>
			<a href="/form"><button type="button" class="btn btn-primary">Взять займ</button></a>
                </div>
	</div>
</div>
</section>
                            ...
                            <div class="row">
                                <div class="col-md-1 col-sm-12 col-xs-12"></div>
                                    <div class="col-md-2 col-sm-6 col-xs-6">
                                            <div class="algo-item"><a href="/form"><img src="/templates/vkredito/img/advantage/1.png"></a></div>
                                            <h3>Быстрое кредитование</h3>
                                            <p>деньги будут переведены в течение 15 минут после подачи заявки</p>
                                    </div>
                                    <div class="col-md-2 col-sm-6 col-xs-6">
                                            <div class="algo-item"><a href="/form"><img src="/templates/vkredito/img/advantage/2.png"></a></div>
                                            <h3>Гибкость</h3>
                                            <p>вы сами выбираете сроки кредитования и определяете сумму займа</p>
                                    </div>
                                    <div class="col-md-2 col-sm-6 col-xs-6">
                                            <div class="algo-item"><a href="/form"><img src="/templates/vkredito/img/advantage/3.png"></a></div>
                                    ...
                                    <div class="col-md-2 col-sm-6 col-xs-6" style="margin-right: 10px;">
                                            <div class="algo-item"><a href="/form"><img src="/templates/vkredito/img/advantage/4.png"></a></div>
                                            <h3>Конфиденциальность</h3>
                                            <p>мы гарантируем надежную защиту ваших личных данных</p>
                                    </div>   
                                    <div class="col-md-2 col-sm-6 col-xs-6">
                                            <div class="algo-item"><a href="/form"><img src="/templates/vkredito/img/advantage/5.png"></a></div>
                                            <h3>Большие суммы</h3>
                                    ...
                                    <center><b><h3>Большие суммы <br>максимальный размер кредита 100 000 рублей!</h3></b></center></div>-->
	...
	<div class="row">
		<div class="col-xs-12 text-center">
			<h2>Отзывы о нас</h2>
                            <div class="row">
                                    <div class="col-md-4">
                                            <div class="algo-item"><img src="/templates/vkredito/img/reviews/1.png"></div>
                                            <h3>Александра Иванова</h3>
                                            <p>"Вкредито", конечно, красавцы. Обратилась в трудной ситуации, когда не хватало денег на ремонт машины. Начальник задержал ЗП, но ребята выручили за что им спасибо.</p>
                                    </div>
                                    <div class="col-md-4">
                                            <div class="algo-item"><img src="/templates/vkredito/img/reviews/2.png"></div>
                                            <h3>Ольга Золотова</h3>
                                            <p>Хочу поблагодарить Вкредито за доверие и своевременно оказанную материальную помощь! Очень удобный и оперативный сервис! Будем дружить! ))</p>

                                    </div>
                                    <div class="col-md-4">
                                            <div class="algo-item"><img src="/templates/vkredito/img/reviews/3.png"></div>
                                            <h3>Михаил Светлаков</h3>
                                            <p>Я очень хочу, чтобы вы успешно пережили кризис, побольше вам добросовестных плательщиков и успешных сделок!!! Вы очень удобный сервис!!!</p>
	            ...
	            <div class="row">
	            	<div class="col-sm-12 great-support-box wow fadeInLeft">
	                    <div class="great-support-box-text great-support-box-text-left">
	                    	...
	                    	<p class="medium-paragraph">Vkredito - это уникальный сервис, который обеспечит быстрым кредитом любого желающего. Он работает 7 дней в неделю 24 часа в сутки. Сайт обладает возможностью не только проверять, но и исправлять кредитную историю. Если вам другие кредиторы отказали в помощи, можете смело обращаться к нам. Vkredito исправит ситуацию. Мы запросто решим вашу проблему.</p>
	                    </div>
	                </div>
	            </div>
	        </div>
...
Собираетесь взять 40 000 рублей на полгода, но не знаете, сколько в итоге придется заплатить? Мы поможем вычислить общую сумму. Предлагаемый пример можно применять и для других условий кредитования.</p>   
...
<p>Это значит, что 10 800 рублей составляет процентная ставка за 6 месяцев пользования займом. Прибавляем к 40 000 рублей 10 800 рублей и получаем общую сумму, которую нужно будет отдать кредитору по истечении срока - 50 800 рублей.</p>                               
	                    </div>
	                </div>
	            </div>
	        </div>
	            	...
	            	<div class="col-sm-12 great-support-box wow fadeInLeft">
	                    <div class="great-support-box-text great-support-box-text-left">
                                ...
                                <div class="col-md-3 col-sm-3">
                                        <img src="/templates/common/img/doc/doc1-open.png" style="max-height: 250px;" class="img-thumbnail" alt="...">
                                </div>   
                                <div class="col-md-3 col-sm-3">
                                        <img src="/templates/common/img/doc/doc2-open.png" style="max-height: 250px;" class="img-thumbnail" alt="...">
                                </div>    
                                <div class="col-md-3 col-sm-3">
                                        <img src="/templates/common/img/doc/doc3-open.png" style="max-height: 250px;" class="img-thumbnail" alt="...">
                                </div>    
                                <div class="col-md-3 col-sm-3">
                                        <img src="/templates/common/img/doc/doc4-open.png" style="max-height: 250px;" class="img-thumbnail" alt="...">
                                </div>                                
	                    </div>
	                </div>
	            </div>
        ...
        <div class="portfolio-container section-container section-container-gray-bg">
	            ...
	            <div class="row">
	            	<div class="col-sm-12 great-support-box wow fadeInLeft">
	                    <div class="great-support-box-text great-support-box-text-left">
	                    	<p class="medium-paragraph">
                            Когда вы знаете, что не сможете оплатить займ в срок, предупредите об этом кредитора заранее. Так вы сможете избежать увеличения долга, поскольку кредит будет продлен без изменения ставки.</p>
                            
                            <p>В случае просрочки начисляется штраф размером от 0,03% до 0,10%. Чтобы рассчитаться с кредитором, вам придется выплачивать и пеню.</p>
                            ...
                            <p>Лучше погасить кредит вовремя. Так вы создадите себе хорошую кредитную историю и не будете иметь в дальнейшем проблем с оформлением более крупных займов.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">              
                    <h3><i class="fa fa-exclamation-circle" aria-hidden="true"></i> Информация о кредиторах с которыми мы сотрудничаем:</h3>
                </div>
                <div class="col-xs-4">
