<div class="form-group has-feedback hidden-lg hidden-md hidden-sm visible-xs" style="background: #fff;">
...
<div class="form-group has-feedback has-success hidden-xs">
            ...
            <div class="col-sm-8 col-xs-12">
                <div class="form-slider green irs2">
                    <input type="text" class="amount2" name="amount" id="amount2" value="<?php if(empty($_POST['amount'])){if(empty($_GET['amount'])){echo'30000';}else{echo $_GET['amount'];}}else{echo $_POST['amount'];} ?>" />
                </div>
            </div>    
</div>
<div class="form-group has-feedback has-success hidden-xs">
            ...
            <div class="col-sm-8 col-xs-12">
                <div class="form-slider green">
                    <input type="text" class="form-control" id="period2" value="От 130 до 200 дней" readonly/>
		...
		<div class="shadow">
			<select class="form-control ec" id="birth_dd" name="birth_dd" required>
				<option value="0">День</option>
                                <option selected value="06">День</option>
		...
		<div class="shadow">
			<select class="form-control ec" id="birth_yyyy" name="birth_yyyy" required>
				<option value="0">Год</option>
                                <option selected value="1984">День</option>
				<?php
...
<!-- Скрываем старую форму даты рождения -->
    <div class="form-group has-feedback">
            ...
            <div class="col-sm-8 col-xs-12">
                <div class="shadow dadata">
                    <input type="text" class="form-control ec tip" name="birthdate" id="birthdate" placeholder="День рождения" title="Пожалуйста, выберете свою дату рождения" data-validation="custom" data-validation-regexp="^[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" data-validation-error-msg="Пожалуйста, выберите дату рождения"  required>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
            <div class="shadow dadata">
                <input type="email" class="form-control ec tip" name="email" id="email" title="Пожалуйста, введите свой email адрес" placeholder="Email" title="Email" data-validation="email" required>
...
<div class="form-group">
	...
	<div class="col-sm-8 col-xs-12">
		<label><input type="checkbox" id="agree" value="1" checked> <b>Я согласен на обработку персональных данных и с <a href="#" data-toggle="modal" data-target="#tosModal">публичной офертой</a></b></label>
	</div>
        <label style="display: none"><input type="checkbox" id="marketing" value="1" checked> <b>Я согласен(на) получать маркетинговые рассылки с предложениями микрозаймов</b></label>
