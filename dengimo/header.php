...
<![endif]-->
	...
	<script>
		...
		ga('create', 'UA-45591397-16', 'auto', {
			'name': 'vteleport_ru',
			'allowLinker': true
		});
		ga('vteleport_ru.require', 'linker');
		ga('vteleport_ru.linker:autoLink', ['onezaim.com', 'onezaim.ru', 'manimo.su', 'manimo.ru', 'my-zaim.com',
			'my-zaim.ru', 'upfinance.ru', 'ezaimo.net', 'ezaimo.ru', 'tratimo.ru', 'vivuso.ru', 'vspz.ru', 'zaim365.ru',
			'zaimmigom.ru', 'optima-zaim.ru', 'safezaim.com', 'zaimsrazu.ru', 'zanimalov.ru', 'getzaim.su', 'gutfin.ru',
			'zanimalo.ru', 'kredito24.su', 'kredito24-mail.ru', 'zaimo-mail.ru', 'zaimomail.ru', 'mail-kredito.ru',
			'kreditomail.ru', 'mail-zaimo.ru', 'dengimo.ru', 'dengoman.ru', 'edenga.ru', ' rublimo.ru', 'vkredito.ru',
			'bzaim5.ru', 'dengibystra.ru'
		]);
