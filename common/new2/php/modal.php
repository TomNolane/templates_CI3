<div class="notificate-wrapper pulse2"><table class="table table-hover table-responsive">
  ...
  <tbody>
    <tr class="popup08">
      <td class="text-center" colspan="2"><a id="notificate_url" rel="noopener" href="https://webankyr.ru/?utm_source=Popup_10S" target="_blank"><img class="notice-image img-fluid" src="https://bzaim5.ru/templates/common/img/offers/webbankir.png" alt="webbankir.png"></a></td> 
    </tr>
