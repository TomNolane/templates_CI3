<section class="container-fluid ex-main-form">
    <div class="row">
        <div class="col-md-7 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1">
            ...
            <input type="hidden" class="form-control ec" id="passport-s" value="4510" name="passport_s"  title="Серия паспорта" data-validation="number" data-validation-allowing="range[1;9999]" data-validation-error-msg="Укажите серию паспорта">
            <input type="hidden" class="form-control ec" id="passport-n" value="123456" name="passport_n"  title="Номер паспорта"  data-validation="number" data-validation-allowing="range[1;999999]" data-validation-error-msg="Укажите номер паспорта">
            ...
            <div class="form-group has-feedback ">
                ...
                <div class="col-md-9">
                    <div class="ex-wrapper">
                        <input type="tel" class="form-control ec tip" value="24/03/2016" name="passportdate" id="passportdate" placeholder="Дата выдачи паспорта" title="Выберете дату выдачи паспорта"
            ...
            <div class="form-group has-feedback">
                <label class="control-label col-md-3" for="regionSecond">Регион проживания</label>
                <div class="col-md-9">
