...
if ($this->uri->segment(1) != 'form') {
    ...
    <div class="hidden-xs hidden-sm rtb text-center" id="yandex_rtb_R-A-257495-1"></div>
    <!-- Мобильная Yandex.RTB R-A-257495-2 -->
     <div class="hidden-md hidden-lg rtb text-center" id="yandex_rtb_R-A-257495-2"></div>';
}
?> 
        ...
        <div class="row">
            ...
            <div class="col-md-6 hidden-xs hidden-sm spec_footer5">
                <p>
                    ...
                    погашения. ИП «Бабакова К.К.» ОГРНИП 316222500122426 ИНН 222511216499
                </p>
            </div> 
        </div>
    </div>
        ...
        $(document).ready(function () {
            ...
            $('#feedback-send').click(function () {
                ...
                if ((typeof data.phone != 'undefined' && data.phone != '') && (typeof data.email !=
                        'undefined' && data.email != '') && (typeof data.comment != 'undefined' && data
                        .comment != '')) {
                    $.ajax({
                        url: '/feedback/',
                        type: 'POST',
