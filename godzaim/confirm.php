     ...
     <div class="container new_style hidden-sm hidden-xs" style="width: 100%; margin-top: 150px; margin-bottom: -70px;  min-height: 100%;">
        <div class="row">            
            <div class="col-md-3 text-left arrow-down">
                <br/>
                <img src="/templates/godzaim/img/man.png" style="max-height: 400px;">
            </div>
...
src="//www.googleadservices.com/pagead/conversion/830227331/?label=M_bzCPqNnHcQg4fxiwM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
