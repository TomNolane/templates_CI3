        ...
        <div class="row">
            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Я прошёл регистрацию.
                                Как получить заём?</a>
                        </h4>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Почему моя заявка
                                отклонена? Как я могу подать заявку снова?</a>
                        </h4>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Сколько времени
                                рассматривается заявка на займ?</a>
                        </h4>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse4">Я погасил займ. Когда я
                                смогу подать заявку на займ снова?</a>
                        </h4>
                    ...
                    <div id="collapse4" class="panel-collapse collapse">
                        <div class="panel-body text-left">
                            Чтобы подать новую заявку на займ, пройдите в ваш Личный кабинет, выберите желаемую сумму и
                            оформите заявку.
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse5">Сколько я могу получить
                                и на какой срок?</a>
                        </h4>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse6">Как долго ждать
                                перевода на карту/счет?</a>
                        </h4>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse7">Какие документы,
                                подтверждающие доход, я могу предоставить дополнительно?</a>
                        </h4>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse8">Я новый клиент. Сколько
                                я могу занять?</a>
                        </h4>
                    ...
                    <div id="collapse8" class="panel-collapse collapse">
                        <div class="panel-body text-left">
                            Максимальная сумма займа для новых клиентов составляет 7500 руб. Для ответственных клиентов,
                            пользующихся нашими услугами более одного раза, сумма возрастает: во второй раз - до 20000
                            руб, с третьего раза - до 100000 руб.
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse9">Я пенсионер/студент,
                                могу ли я оформить у Вас заявку?</a>
                        </h4>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse10">Как я узнаю какое
                                решение было вынесено по моей заявке?</a>
                        </h4>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title pull-left">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse11">Могу ли я подать
                                заявку на еще один займ, если предыдущий займ не погашен?</a>
                        </h4>
