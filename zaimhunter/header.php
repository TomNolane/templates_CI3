...
<head>
	...
	<meta property="og:url" content="https://zaimhunter.ru/" />
	<meta name="twitter:card" content="https://zaimhunter.ru/templates/zaimhunter/assets/img/pic-email.png"/>
	<meta name="twitter:title" content="Срочные займы круглосуточно без проверок Онлайн"/>
	<meta name="twitter:description" content="zaimhunter - лучший онлайн сервис по выдаче мгновенных займов и кредитов без проверки вашей кредитной истории.Только у нас лучшие кредитные предложения!"/>
	<meta name="twitter:image:src" content="https://zaimhunter.ru/templates/zaimhunter/assets/img/pic-email.png"/>
	<meta name="twitter:url" content="https://zaimhunter.ru/"/>
	<meta name="twitter:domain" content="zaimhunter.ru"/>
    ...
    <?php 
     ...
     .tip-twitter .tip-arrow-top {
         ...
         width:9px;
         height:5px;
         background:url(/templates/zaimhunter/assets/img/tip-twitter_arrows.gif) no-repeat;
     }
     .tip-twitter .tip-arrow-right {
         ...
         width:5px;
         height:9px;
         background:url(/templates/zaimhunter/assets/img/tip-twitter_arrows.gif) no-repeat -9px 0;
     }
     .tip-twitter .tip-arrow-bottom {
         ...
         width:9px;
         height:5px;
         background:url(/templates/zaimhunter/assets/img/tip-twitter_arrows.gif) no-repeat -18px 0;
     }
     .tip-twitter .tip-arrow-left {
         ...
         width:5px;
         height:9px;
         background:url(/templates/zaimhunter/assets/img/tip-twitter_arrows.gif) no-repeat -27px 0;
     }';
     echo '</style>';
