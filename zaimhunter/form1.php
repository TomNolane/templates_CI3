    ...
    <div class="col-sm-6 col-xs-12">
        <div class="ex-anketa-main"> 
            ...
            <div class="form-group has-feedback ex-arrow-on hidden">
                <input type="text" value="06/02/2000" class="form-control ec tip special_form" name="birthdate" id="birthdate" placeholder="День рождения" title="Выберете свою дату рождения"
            ...
            <div class="form-group ex-agreement-check">
                ...
                <label class="hidden">
                    ...
                    <b class="font12">Я согласен(на) получать маркетинговые рассылки с предложениями микрозаймов</b>
                </label>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <a class="btn special_index5 special_form3 text-center" id="next1"> Получить займ <i class="fa fa-caret-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
