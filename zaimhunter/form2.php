...
<div class="row">
    <div class="col-sm-6">
        <div class="ex-anketa-main">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <a id="next2">
                                    <button class="special_index5 special_form3"> Далее </button>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <fieldset id="reg_address">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control ec" name="reg_city" id="reg_city" title="Введите населённый пункт" placeholder="Населённый пункт"
                        data-validation="reg_city" required="" autocomplete="off" value="<?php echo isset($city_name)? $city_name : ''; ?>">
                </div>

                <div class="form-group has-feedback">
                    <input type="text" class="form-control ec" name="reg_street" id="reg_street" palceholder="Название улицы" name="reg_building"
                        id="reg_building" id="reg_street" title="Название улицы" placeholder="Название улицы" data-validation="reg_street"
                        required="" autocomplete="off">
                </div>
                <div class="form-group has-feedback">
                    <input type="text" class="form-control ec" palceholder="Номер дома" name="reg_building" id="reg_building" title="Введите номер дома"
                        placeholder="Номер дома" data-validation="reg_building" required="" autocomplete="off">
                </div>

                <div class="form-group has-feedback hidden">
                    <input type="text" class="form-control ec" palceholder="№ корпуса/строение" name="reg_housing" id="reg_housing" title="Введите номер корпуса/строения"
                        placeholder="Номер корпуса/строения" data-validation="reg_housing" required="" autocomplete="off">
                </div>

                <div class="form-group has-feedback">
                    <input type="text" class="form-control ec" palceholder="Номер квартиры" name="reg_flat" id="reg_flat" title="Введите № квартиры"
                        placeholder="Номер квартиры" data-validation="reg_flat" required="" autocomplete="off">
                </div>
            </fieldset>
        </div>
    </div>
    <div class="col-sm-6 hidden-xs hidden-sm">
        ...
        <p class="text-right">Все вводимые данные защищены
            <br> нашей системой безопасности</p>
    </div>
</div>