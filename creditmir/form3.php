        ...
        <div class="col-md-7 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1">
                ...
                <div class="col-md-9">
                    <div class="ex-wrapper">
                        <input type="text" class="form-control ec tip" name="work_house" placeholder="Номер дома" title="Укажите номер дома" id="work_house"
                            ...
                            required>
                            <p class="text-muted helpblock">Пример: 14 корп.1</p>
                    </div>
                </div>
            </div>
            <div class="form-group has-feedback">
            ...
            <div class="form-group has-feedback">
                <div class="col-md-9 col-md-offset-3 text-center">
                    <a id="getmoney" class="ex-btn-blue text-center" style="width: 100%;text-transform: uppercase; text-decoration: none;">
                        Получить деньги
                    </a>
                </div>
            </div>
