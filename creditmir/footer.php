...
<footer class="ex-main-footer ex-sticky-footer">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="ex-foot-logo">
                    <a href="/"><img src="/templates/creditmir/assets/img/logo-footer.png" alt="logo-footer"></a>
                </div>
            </div>
            <div class="col-md-9 spec_footer4">
                <p>Сервис по подбору выгодных онлайн займов и кредитов находящийся по адресу:<br>
                    Россия, Ленинградская обл. г. Санкт-Петербург, ул. Осипенко, 12, оф 201 <a href="mailto:support@creditmir.ru" class="spec_foot" target="_blank">support@creditmir.ru</a> <span class="hidden-xs hidden-sm">| 8 (960) 950 93 53</span><br>
    ...
    echo '</script>';
    echo '<script>';
    require 'templates/creditmir/assets/js/jquery.suggestions.min.js';
    echo '</script>';
    echo '<script>';
    require 'templates/creditmir/assets/js/coockie.js';
    echo '</script>';
    echo '<script>';
    require 'templates/creditmir/assets/js/custom.js';
    echo '</script>'; 
    echo '<script>';
    require 'templates/creditmir/assets/js/settings_main.js';
    echo '</script>'; 
    echo '<script>';
    ...
    { 
        ...
        echo '</script>';
        echo '<script>';
        require 'templates/creditmir/assets/js/loanCalculator.js';
        echo '</script>';
    ?>
    ...
    $("#rangeSlider3").ionRangeSlider({
        ...
        grid: false,
        from: 10,
        values: [100000,150000, 200000, 300000, 400000, 500000, 600000, 700000,
...
<?php
 ...
 echo '<script>';
    require 'templates/creditmir/assets/js/modal.js';
echo '</script>';
?>
