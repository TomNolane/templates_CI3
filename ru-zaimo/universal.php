...
<body class="t-body" style="margin: 0px;">
    <header class="hidden" style="margin: 0 20px; top: 0; text-align: center">
        <a class="navbar-brand" href="/">
            <img src="/templates/ru-zaimo/img/universal/<?=$main?>_logo.png" class="t338__logo t-img"
        ...
        <div id="rec63469314" class="r t-rec t-screenmin-480px" style=" " data-animationappear="off"
            ...
            <div class="t-cover" id="recorddiv63469314"
                ...
                <div class="t-cover__carrier loaded" id="coverCarry63469314" data-content-cover-id="63469314"
                    ...
                    style="height: 100vh; background-attachment: scroll; background-image: url(&quot;/templates/ru-zaimo/img/universal/<?=$main?>_header.jpg&quot;);">
                </div>
                                ...
                                <div class="t338" style="">
                                    <div data-hook-content="covercontent">
                                        <div class="t339__wrapper"> <a href="<?=$link?>" target="_blank"><img
                                                    ...
                                                    src="/templates/ru-zaimo/img/universal/<?=$main?>_logo.png"
            ...
            <div class="t490">
                ...
                <div class="text-center">
                    ...
                    <a href="<?=$link?>" target="_blank">
                        <img src="/templates/ru-zaimo/img/universal/<?=$main?>_body.jpg"
                            data-original="/templates/ru-zaimo/img/universal/<?=$main?>_body.jpg" class="t-img loaded"
                            alt="t-img loaded" style="width:100%;">
                    </a>
                    <?php } else { ?>
                    <div class="flex-container">
                        <div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico1.png">
                            <p class="px22">Низкая ставка: <br><span class="prcb pink">1,5%</span></p>
                        </div>
                        <div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico2.png">
                            <p class="px22">Быстрое одобрение: <br><span class="prcb pink">15&nbsp;минут</span></p>
                        </div>
                        <div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico3.png">
                            <p class="px22">Срок кредитования: <br><span class="prcb pink">до 30 дней</span></p>
                        </div>
                        <div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico4.png">
                            <p class="px22">На сумму: <br><span class="prcb pink">до 30 000 рублей</span></p>
                        </div>
                        <div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico5.png">
                            <p class="px22">Нужен <br><span class="prcb pink">только паспорт</span></p>
                        </div>
                        <div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico6.png">
    ...
    if($this->uri->segment(2) != 'webbankir') { ?>
                    ...
                    <div class="t-col t-col_12">
                        <div class="t-section__topwrapper t-align_center click_offer">
                            <a href="<?=$link?>" target="_blank"> <img class="t-img loaded"
                                    ...
                                    src="/templates/ru-zaimo/img/universal/<?=$main?>_logo.png"></a>
                        </div>
                    </div>
                </div>
                <?php } ?>
        ...
        <div id="rec63469085" class="r t-rec t-rec_pt_30 t-rec_pb_90"
            ...
            <div class="t420">
                <div class="t-container">
                    <?php if($domain == 'ru-zaimo.ru') { ?>
                    <img src="/templates/ru-zaimo/img/ru-zaimo.png" style="margin: 0 20px;" alt="t338__logo t-img"
                        class="t338__logo t-img">
                    <?php } else { ?>
                    <img src="/templates/ru-zaimo/img/sumas.png" style="margin: 0 20px;" alt="t338__logo t-img"
                        class="t338__logo t-img">
                    <?php } ?>
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/53258287" style="position:absolute; left:-9999px;" alt="" /></div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
</body>
