...
<head>
    ...
    <link rel="stylesheet" href="/templates/ru-zaimo/css/universal/<?=$universal_folder?>/tilda-grid-3.0.min.css"  media="all">
    <link rel="stylesheet" href="/templates/ru-zaimo/css/universal/<?=$universal_folder?>/tilda-blocks-2.12.css"  media="all">
    <link rel="stylesheet" href="/templates/ru-zaimo/css/universal/<?=$universal_folder?>/tilda-animation-1.0.min.css"  media="all">
    <link rel="stylesheet" href="/templates/ru-zaimo/css/universal/<?=$universal_folder?>/tilda-slds-1.4.min.css"  media="all">
    <link rel="stylesheet" href="/templates/ru-zaimo/css/universal/<?=$universal_folder?>/tilda-zoom-2.0.min.css"  media="all">
    <link rel="stylesheet"  href="/templates/ru-zaimo/css/universal/<?=$universal_folder?>/custom.css">
    ...
    <script src="/templates/ru-zaimo/js/universal/lazyload-1.3.min.js" ></script>
    <script src="/templates/ru-zaimo/js/universal/tilda-animation-1.0.min.js" ></script>
    <script src="/templates/ru-zaimo/js/universal/typed.min.js" ></script>
    <script src="/templates/ru-zaimo/js/universal/tilda-slds-1.4.min.js" ></script>
    <script src="/templates/ru-zaimo/js/universal/hammer.min.js" ></script>
    <script src="/templates/ru-zaimo/js/universal/tilda-zoom-2.0.min.js" ></script>
    <script  src="//cdn.sendpulse.com/js/push/33505121ee025ec05bae5fd44c7ba208_1.js" async></script>
    <style>
    <?php
    echo '.t338__logo{float: unset;max-width: 320px !important;}.t338__title{margin-bottom: 40px;padding-top: 200px;text-align: center;} .t-prefix_1{padding-left: 0;padding-right: 0;}';
...
<body class="t-body" style="margin: 0px;">
    <header class="hidden" style="margin: 0 20px; top: 0; text-align: center">
        <a class="navbar-brand" href="/">
                <img src="/templates/ru-zaimo/img/universal/<?=$main?>_logo.png" class="t338__logo t-img" alt="t338__logo t-img">
            </a> 
  </header>
    <!--allrecords-->
    <div id="allrecords" class="t-records" data-hook="blocks-collection-content-node" data-tilda-project-id="663907"
        ...
        <div id="rec63469314" class="r t-rec t-screenmin-480px" style=" " data-animationappear="off" data-record-type="338"
            ...
            <!-- cover -->
            <div class="t-cover" id="recorddiv63469314"  style="height:100vh; background-image:url(&#39;/templates/ru-zaimo/img/universal/<?=$main?>_header.jpg&#39;);">
                <div class="t-cover__carrier loaded" id="coverCarry63469314" data-content-cover-id="63469314"
                    data-content-cover-bg="/templates/ru-zaimo/img/universal/<?=$main?>_header.jpg"
                    data-content-cover-height="100vh" data-content-cover-parallax="" style="height: 100vh; background-attachment: scroll; background-image: url(&quot;/templates/ru-zaimo/img/universal/<?=$main?>_header.jpg&quot;);"
                    ></div>
                                    ...
                                    <div data-hook-content="covercontent">
                                        <div class="t339__wrapper"> <a href="<?=$link?>"
                                                target="_blank"><img class="t338__logo t-img loaded" id="spec" alt="t338__logo t-img" data-tu-max-width="800"
                                                    data-tu-max-height="800" style="max-width:250px;" src="/templates/ru-zaimo/img/universal/<?=$main?>_logo.png"
                                                    data-original="/templates/ru-zaimo/img/universal/<?=$main?>_logo.png"
        ...
        <div id="rec63581518" class="r t-rec t-screenmax-480px" style=" " data-animationappear="off" data-record-type="338"
            ...
            <!-- cover -->
            <div class="t-cover" id="recorddiv63581518"  style="height:100vh; background-image:url(&#39;/templates/ru-zaimo/img/universal/<?=$main?>_header.jpg&#39;);">
                                    ...
                                    <div data-hook-content="covercontent">
                                        <div class="t339__wrapper"> <a href="<?=$link?>"
                                                target="_blank"><img class="t338__logo t-img t-animate t-animate_started"
                                                    ...
                                                    src="/templates/ru-zaimo/img/universal/<?=$main?>_logo.png" data-original="/templates/ru-zaimo/img/universal/<?=$main?>_logo.png"
            ...
            <div class="t490">
                ...
                <div class="text-center">
                    ...
                    <a href="<?=$link?>" target="_blank">
                        <img src="/templates/ru-zaimo/img/universal/<?=$main?>_body.jpg" data-original="/templates/ru-zaimo/img/universal/<?=$main?>_body.jpg"
                                class="t-img loaded" alt="t-img loaded"  style="width:100%;">
                    </a>
                    <?php } else { ?>
                        <div class="flex-container"><div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico1.png"><p class="px22">Низкая ставка: <br><span class="prcb pink">1,5%</span></p></div><div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico2.png"><p class="px22">Быстрое одобрение: <br><span class="prcb pink">15&nbsp;минут</span></p></div><div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico3.png"><p class="px22">Срок кредитования: <br><span class="prcb pink">до 30 дней</span></p></div><div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico4.png"><p class="px22">На сумму: <br><span class="prcb pink">до 30 000 рублей</span></p></div><div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico5.png"><p class="px22">Нужен <br><span class="prcb pink">только паспорт</span></p></div><div><img alt="" src="/templates/ru-zaimo/img/universal/0/ico6.png"><p class="px22">Переводим сразу на карту <br><span class="prcb pink">Не надо никуда ехать</span></p></div></div>
                    <?php } ?>
                </div>
        ...
        <div class="row">
            <div class="col-xs-12 hidden-xs">
                <div class="ex-info-block ">
                    <h3>О проекте</h3> 
                    <p><?=$domain?> - это самый удобный и выгодный сервис по получению онлайн-займов. Благодаря используемым
                ...
                <div class="t-section__container t-container">
                    <div class="t-col t-col_12">
                        <div class="t-section__topwrapper t-align_center click_offer">
                            <a href="<?=$link?>" target="_blank"> <img  class="t-img loaded"  style="width:100%; max-width:300px;" alt="t-img loaded" src="/templates/ru-zaimo/img/universal/<?=$main?>_logo.png"></a>
                        </div>
                    </div>
                </div>
                <?php } ?>
        ...
        <div id="rec63469085" class="r t-rec t-rec_pt_30 t-rec_pb_90" style="padding-top:30px;padding-bottom:90px;background-color:#3b3b3b;" data-animationappear="off" data-record-type="420" data-bg-color="#3b3b3b">
            ...
            <div class="t420">
                <div class="t-container">
                    ...
                    <img src="/templates/ru-zaimo/img/ru-zaimo.png" style="margin: 0 20px;" alt="t338__logo t-img" class="t338__logo t-img">
                     <?php } else { ?>
                    <img src="/templates/ru-zaimo/img/sumas.png" style="margin: 0 20px;" alt="t338__logo t-img" class="t338__logo t-img">
                    <?php } ?>
                    ...
                    <br>ООО «Альянс» ОГРН 5177746353054 ИНН 9705113909 КПП 770501001 | +7(495) 006 19 61 | Россия, Санкт-Петербург, улица Осипенко, 12</span></p>
                </div>
            </div>
        </div>
