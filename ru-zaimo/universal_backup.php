...
<head>
    ...
    <meta property="og:url" content="https://ru-zaimo.ru/<?=$main?>">
    ...
    <link rel="canonical" href="https://ru-zaimo.ru/<?=$main?>">
...
<body class="t-body" style="margin: 0px;">
    ...
    <div id="allrecords" class="t-records" data-hook="blocks-collection-content-node" data-tilda-project-id="663907"
        ...
        <div id="rec63469314" class="r t-rec t-screenmin-480px" style=" " data-animationappear="off" data-record-type="338"
            ...
            <!-- cover -->
            <div class="t-cover" id="recorddiv63469314" bgimgfield="img" style="height:100vh; background-image:url(&#39;/templates/ru-zaimo/img/universal/<?=$main?>_header.jpg&#39;);">
        ...
        <div id="rec63581518" class="r t-rec t-screenmax-480px" style=" " data-animationappear="off" data-record-type="338"
            ...
            <!-- cover -->
            <div class="t-cover" id="recorddiv63581518" bgimgfield="img" style="height:100vh; background-image:url(&#39;/templates/ru-zaimo/img/universal/<?=$main?>_header.jpg&#39;);">
                                    ...
                                    <div data-hook-content="covercontent">
                                        <div class="t339__wrapper"> <a href="<?=$link?>"
                                                target="_blank"><img class="t338__logo t-img t-animate t-animate_started"
                                                    ...
                                                    imgfield="img2" data-hook-clogo="coverlogo" alt="t338__logo t-img"></a>
                ...
                <div>
                    ...
                    <a href="<?=$link?>" target="_blank">
                        <img src="/templates/ru-zaimo/img/universal/<?=$main?>_body.jpg" data-original="/templates/ru-zaimo/img/universal/<?=$main?>_body.jpg"
                                class="t-img loaded" alt="t-img loaded" imgfield="li_img__1476968690512" style="width:100%;">
                    </a>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="ex-info-block ">
                    <h3>О проекте</h3> 
                    <p>Ru-zaimo - это самый удобный и выгодный сервис по получению онлайн-займов. Благодаря используемым
...
(adsbygoogle = window.adsbygoogle || []).push({});
    ...
    <?php } ?>
        ...
        <div id="rec63469085" class="r t-rec t-rec_pt_30 t-rec_pb_90" style="padding-top:30px;padding-bottom:90px;background-color:#3b3b3b; "
            ...
            <div class="t420">
                <div class="t-container">
                    <img src="/templates/ru-zaimo/img/ru-zaimo.png" style="margin: 0 20px;" class="t338__logo t-img">
