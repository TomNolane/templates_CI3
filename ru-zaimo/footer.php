            ...
            <div class="t420">
                <div class="t-container">
                    ...
                    <img src="/templates/ru-zaimo/img/ru-zaimo.png" style="margin: 0 20px;" class="t338__logo t-img">
                     <?php } else { ?>
                    <img src="/templates/ru-zaimo/img/sumas.png" style="margin: 0 20px;" class="t338__logo t-img">
                    <?php } ?>
    ...
    <script>
   // function checkMe(){var e=document.getElementById("agree");null!=e&&(e.checked?$("#my_btn").css("display","block"):$("#my_btn").css("display","none"))}function checkMee(){var e=document.getElementById("agree");null!=e&&(e.checked?$("#next1f").css("visibility","visible"):$("#next1f").css("visibility","hidden"))}
