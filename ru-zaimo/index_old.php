...
<head>
    ...
    <!-- Title  -->
    <title>MoneyMan - займы круглосуточно</title>

    <!-- Favicon  -->
    <link rel="shortcut icon" href="img/core-img/favicon.ico">

    <!-- Style css -->
    <link rel="stylesheet" href="/templates/ru-zaimo/style.css">
...
overflow-x: auto;
    ...
    <div class="notificate-wrapper pulse2">
        <table class="table table-hover table-responsive">
            ...
            <tbody>
                <tr class="popup08">
                    <td class="text-center" colspan="2"><a id="notificate_url" rel="noopener" href="https://pxl.leads.su/click/4570e3956021b3e71294cba0f7a11814?aff_sub1=ru-zaimo.ru"
                            onclick="yaCounter51370192.reachGoal('target'); return true;" target="_blank"><img class="notice-image img-fluid"
                                src="https://bzaim5.ru/templates/common/img/offers/moneyman.png" alt="moneyman.png"></a></td>
                </tr>
                ...
                <tr class="popup08">
                    <td class="text-center" colspan="2">
                        <a id="notificate_url2" href="https://pxl.leads.su/click/4570e3956021b3e71294cba0f7a11814?aff_sub1=ru-zaimo.ru"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-2 col-xs-9">
                        <!-- Logo Area -->
                        <div class="logo_area">
                            <a href="index.html"><img src="/templates/ru-zaimo/img/core-img/logo.png" alt=""> MoneyMan</a>
                        </div>
                    </div>
                    ...
                    <div class="table">
                        <div class="table_cell ">
                            <h2 class="font-poiret-one pulsate">Вам одобрено <span class="pulsate">9 000 рублей</span>
                                на карту</h2>
                            <a class="btn btn-default pulse2" onclick="yaCounter51370192.reachGoal('target'); return true;"
                                href="https://pxl.leads.su/click/4570e3956021b3e71294cba0f7a11814?aff_sub1=ru-zaimo.ru" role="button">Оформить
                                заём</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="slide_text">
                    <div class="table">
                        <div class="table_cell">
                            ...
                            <a class="btn btn-default" onclick="yaCounter51370192.reachGoal('target'); return true;" href="https://pxl.leads.su/click/4570e3956021b3e71294cba0f7a11814?aff_sub1=ru-zaimo.ru" role="button">Оформить заём</a>
                        </div>
                    </div>
                </div>
            </div> -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4">
                    ...
                    <a href="https://pxl.leads.su/click/4570e3956021b3e71294cba0f7a11814?aff_sub1=ru-zaimo.ru" onclick="yaCounter51370192.reachGoal('target'); return true;">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6 wow fadeInUp">
                        ...
                        <div class="about_us_text text-left">
                            ...
                            <div class="text-center"><a href="https://pxl.leads.su/click/4570e3956021b3e71294cba0f7a11814?aff_sub1=ru-zaimo.ru"
                                    onclick="yaCounter51370192.reachGoal('target'); return true;" class="btn pulse2">Оформить
                                    заём</a></div>
                        </div>
                    </div>
            ...
            <div class="row second_part">
                ...
                <div class="col-md-5 col-md-offset-2">
                    <div class="why_choose_us_text_area second_area">
                        ...
                        <div class="text-center"> <a href="https://pxl.leads.su/click/4570e3956021b3e71294cba0f7a11814?aff_sub1=ru-zaimo.ru"
                                onclick="yaCounter51370192.reachGoal('target'); return true;" class="btn btn_spec pulse2">Оформить
                                заём</a></div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        var t = document.querySelectorAll('a[href="https://pxl.leads.su/click/4570e3956021b3e71294cba0f7a11814?aff_sub1=ru-zaimo.ru"]');
