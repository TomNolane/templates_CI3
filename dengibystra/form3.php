    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        <label class="label-required" for="work_name_help">Место работы</label>
                        <input type="text" class="form-control ec tip" name="work_name" id="work_name" placeholder="Место работы" title="Укажите, ваше место работы" data-sanitize="capitalize"  data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\-\.\(\)\s]+$" data-validation-error-msg="Укажите, ваше место работы" required>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control ec tip" name="work_occupation" id="work_occupation" placeholder="Должность" title="Укажите, вашу должность" data-sanitize="capitalize"  data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\-\.\(\)\s]+$" data-validation-error-msg="Укажите, вашу должность" required>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="tel" class="form-control ec tip" min="0" max="360" name="work_experience" id="work_experience" placeholder="Стаж работы (в месяцах)" title="Введите ваш стаж работы в месяцах" data-validation="number" data-validation-error-msg="Введите ваш стаж работы в месяцах" required>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <input type="tel" class="form-control ec tip" name="work_salary" id="work_salary" placeholder="Зарплата (в рублях)" title="Введите вашу среднюю зарплату"  data-validation="number" data-validation-error-msg="Введите среднюю зарплату" maxlength="6" required>
                ...
                <div class="col-sm-6"> 
                        ...
                        <div class="col-sm-6">
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" class="form-control ec tip" name="work_house" placeholder="№ дома" title="Укажите № дома" id="work_house"  data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Укажите № дома" required>
                ...
                <div class="row"> 
                        ...
                        <div class="col-sm-6">
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" class="form-control ec tip" name="work_building" placeholder="Строение/корпус" title="Укажите строение/корпус" id="work_building"  data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Укажите строение/корпус" data-validation-optional="true">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" class="form-control ec tip" name="work_office" placeholder="Офис" title="Укажите № офиса" id="work_office" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Укажите № офиса" data-validation-optional="true">
