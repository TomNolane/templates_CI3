...
echo ' <tr> 
                ...
                <td><a   href="'.$item['link'].'" onclick="markTarget(\'pixel_result\', \''.$item['title'].'\', \''.$pixel.'\')" target="_blank">
                    ...
                    <br>
                    <div><span class="table_text text-left">Максимальный срок</span><span class="table_text2 text-right"> <b>'.$item["period"].' '.$_plural_days[plural_type($item['period'])].'</b>&emsp;&emsp;&emsp;</span></div>
                    </a>
                </td> 
