    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-md-9">
                    <div class="ex-wrapper">
                        <input type="tel" class="form-control ec tip" value="12" placeholder="Стаж работы в месяцах" name="work_experience" id="work_experience"
            ...
            <div class="form-group has-feedback">
                <div class="col-md-9 col-md-offset-3 text-center">
                    <a class="ex-main-btn btn2 text-center" id="form-send">Получить деньги</a>
                </div>
            </div>
        </div>
    </div>
