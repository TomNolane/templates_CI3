...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip" name="street" id="street" placeholder="Улица" title="Улица" required title="Пожалуйста, укажите, улицу" pattern="^[А-Яа-яЁё\d\s\-\,\#\.\+\(\)]+$" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\-\.\(\)\s\d]+$" data-validation-error-msg="Пожалуйста, укажите, улицу">
