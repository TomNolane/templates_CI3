<div class="form-group has-feedback">
    <label class="control-label label-required">Серия и номер паспорта</label>
...
<div class="form-group has-feedback">
    <label class="control-label label-required">Дата выдачи</label>
...
<div class="form-group has-feedback">
    <label class="control-label label-required">Код подразделения*</label>
...
<div class="form-group has-feedback">
    <label class="control-label label-required">Кем выдан*</label>
...
<div class="form-group has-feedback">
    <label class="control-label label-required">Место рождения*</label>
...
<div class="form-group">
	<label class="control-label label-required">Тип регистрации*</label>
