...
<head>
	...
	<meta property="og:image" content="https://bzaim5.ru/templates/bzaim/img/bg.jpg"/>
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://bzaim5.ru/" />

	<meta name="twitter:card" content="https://bzaim5.ru/templates/bzaim/img/bg.jpg"/>
	...
	<meta name="twitter:image:src" content="https://bzaim5.ru/templates/bzaim/img/bg.jpg"/>
    ...
    <?php 
    echo '<style>'; 
    require "templates/bzaim/css/bootstrap.min.css"; 
    echo '</style>';
    ...
    .tip-twitter .tip-arrow-top {
        ...
        width:9px;
        height:5px;
        background:url(/templates/bzaim/img/tip-twitter_arrows.gif) no-repeat;
    }
    .tip-twitter .tip-arrow-right {
        ...
        width:5px;
        height:9px;
        background:url(/templates/bzaim/img/tip-twitter_arrows.gif) no-repeat -9px 0;
    }
    .tip-twitter .tip-arrow-bottom {
        ...
        width:9px;
        height:5px;
        background:url(/templates/bzaim/img/tip-twitter_arrows.gif) no-repeat -18px 0;
    }
    .tip-twitter .tip-arrow-left {
        ...
        width:5px;
        height:9px;
        background:url(/templates/bzaim/img/tip-twitter_arrows.gif) no-repeat -27px 0;
    }
    '; 
    echo '</style>'; 
    }
