...
<div class="form-group has-feedback dadata">
    <label class="control-label label-required">Фамилия*</label>
...
<div class="form-group has-feedback dadata">
    <label class="control-label label-required">Имя*</label>
...
<div class="form-group has-feedback dadata">
    <label class="control-label label-required">Отчество*</label>
...
<div class="form-group has-feedback">
    <label class="control-label label-required">Дата рождения</label>
...
<div class="form-group has-feedback">
    <label class="control-label label-required">Телефон*</label>
...
<div class="form-group has-feedback dadata">
    <label class="control-label label-required">Почта*</label>
...
<div class="form-group">
    <label class="control-label label-required">Кредитная история*</label>
