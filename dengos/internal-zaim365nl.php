...
<body class="t-body" style="margin: 0px;">
    <header class="hidden" style="margin: 0 20px; top: 0; text-align: center">
        <a class="navbar-brand" href="/">
                <img src="/templates/dengos/img/universal/<?=$main?>_logo.png" class="t338__logo t-img" alt="t338__logo t-img">
            </a> 
  </header>
    <!--allrecords-->
    <div id="allrecords" class="t-records" data-hook="blocks-collection-content-node" data-tilda-project-id="663907"
        ...
        <div id="rec63469314" class="r t-rec t-screenmin-480px" style=" " data-animationappear="off" data-record-type="338"
            ...
            <!-- cover -->
            <div class="t-cover" id="recorddiv63469314"  style="height:100vh; background-image:url(&#39;/templates/dengos/img/universal/<?=$main?>_header.jpg&#39;);">
        ...
        <div id="rec63581518" class="r t-rec t-screenmax-480px" style=" " data-animationappear="off" data-record-type="338"
            ...
            <div class="t-cover" id="recorddiv63581518"  style="height:100vh; background-image:url(&#39;/templates/dengos/img/universal/<?=$main?>_header.jpg&#39;);">
                <!-- <div class="t-cover__carrier" id="coverCarry63581518" data-content-cover-id="63581518"
                    data-content-cover-bg="/templates/dengos/img/universal/<?=$main?>.jpg"
        ...
        <div id="rec63469080" class="r t-rec t-rec_pt_90 t-rec_pb_75" style="padding-top:35px;padding-bottom:75px;background-color:#ffffff; "
            ...
            <div class="t490">
                ...
                <div class="text-center">
                    ...
                    <?php } else { ?>
                        <div class="flex-container"><div><img alt="" src="/templates/dengos/img/universal/0/ico1.png"><p class="px22">Низкая ставка: <br><span class="prcb pink">1,5%</span></p></div><div><img alt="" src="/templates/dengos/img/universal/0/ico2.png"><p class="px22">Быстрое одобрение: <br><span class="prcb pink">15&nbsp;минут</span></p></div><div><img alt="" src="/templates/dengos/img/universal/0/ico3.png"><p class="px22">Срок кредитования: <br><span class="prcb pink">до 30 дней</span></p></div><div><img alt="" src="/templates/dengos/img/universal/0/ico4.png"><p class="px22">На сумму: <br><span class="prcb pink">до 30 000 рублей</span></p></div><div><img alt="" src="/templates/dengos/img/universal/0/ico5.png"><p class="px22">Нужен <br><span class="prcb pink">только паспорт</span></p></div><div><img alt="" src="/templates/dengos/img/universal/0/ico6.png"><p class="px22">Переводим сразу на карту <br><span class="prcb pink">Не надо никуда ехать</span></p></div></div>
                    <?php } ?>
                </div>
                ...
                <div class="t-section__container t-container">
                    <div class="t-col t-col_12">
                        <div class="t-section__topwrapper t-align_center click_offer">
                            <a href="<?=$link?>" target="_blank"> <img  class="t-img loaded"  style="width:100%; max-width:300px;" alt="t-img loaded" src="/templates/dengos/img/universal/<?=$main?>_logo.png"></a>
                        </div>
                    </div>
                </div>
                <?php } ?>
        ...
        <div id="rec63469085" class="r t-rec t-rec_pt_30 t-rec_pb_90" style="padding-top:30px;padding-bottom:90px;background-color:#3b3b3b;" data-animationappear="off" data-record-type="420" data-bg-color="#3b3b3b">
            ...
            <div class="t420">
                <div class="t-container">
                    ...
                    <img src="/templates/dengos/img/dengos.png" style="margin: 0 20px;" alt="t338__logo t-img" class="t338__logo t-img">
                     <?php } else { ?>
                    <img src="/templates/dengos/img/sumas.png" style="margin: 0 20px;" alt="t338__logo t-img" class="t338__logo t-img">
                    <?php } ?>
