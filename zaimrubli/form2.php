                ...
                <div class="ex-form-wrap">
                    <div class="row">
                        <div class="">
                            ...
                            <div class="form-group has-feedback">
                                <label class="control-label col-md-4" for="passport_code">Код подразделения
                                </label>
                                <div class="col-md-8">
                                    <div class="ex-wrapper">
                            ...
                            <div class="form-group has-feedback">
                                <label class="control-label col-md-4" for="birthplace">Место рождения
                                </label>
                                <div class="col-md-8">
                                    <div class="ex-wrapper">
                            ...
                            <div class="form-group has-feedback">
                                <label class="control-label col-md-4" for="city">Населённый пункт
                                </label>
                                <div class="col-md-8">
                                    <div class="ex-wrapper">
                            ...
                            <div class="form-group has-feedback">
                                <label class="control-label col-md-4" for="building">Номер дома
                                </label>
                                <div class="col-md-8">
                                    <div class="ex-wrapper">
                            ...
                            <div class="form-group has-feedback">
                                <label class="control-label col-md-4" for="reg_type">Тип регистрации
                                </label>
                                <div class="col-md-8">
                                    <div class="ex-wrapper ex-arrow">
                            ...
                            <div class="form-group has-feedback has-feedback hidden">
