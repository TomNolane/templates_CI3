...
<footer class="ex-main-footer ex-sticky-footer">
        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="ex-foot-logo">
                    <a href=""><img src="/templates/zaimomix/assets/img/logo-footer.png" alt="logo-footer.png"></a>
                </div>
            </div>
            <div class="col-lg-10">
    ...
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix/assets/js/jquery.pickmeup.twitter-bootstrap.js';
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix/assets/js/pickmeup.min.js';
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix/assets/js/jquery.form-validator.js';
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix/assets/js/jquery.suggestions.min.js';
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix/assets/js/coockie.js';
    echo '</script>';
    require 'templates/common/detect.min.php';
    echo '<script>';
    require 'templates/zaimomix/assets/js/custom.js';
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix/assets/js/settings_form.js';
    echo '</script>';
    ?>
...
{ 
    ...
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix/assets/js/loanCalculator.js';
    echo '</script>';
?>
...
<?php require 'templates/zaimomix/assets/js/owl.carousel.min.js';?>
