<section class="ex-main-form">
                ...
                <div class="col-sm-3">
                    ...
                    ?>
                                ...
                                <div class="form-group has-feedback row">
                                    <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end"
                                           for="passportdate">Дата выдачи</label>
                                    <div class="col-md-9">
                                        <div class="ex-wrapper">
                                ...
                                <div class="form-group has-feedback row">
                                    <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end"
                                           for="passport_code">Код подразделения</label>
                                    <div class="col-md-9">
                                        <div class="ex-wrapper">
                                ...
                                <div class="form-group has-feedback row">
                                    <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end"
                                           for="passport_who">Кем выдан</label>
                                    <div class="col-md-9">
                                        <div class="ex-wrapper">
                                ...
                                <div class="form-group has-feedback row">
                                    <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end"
                                           for="birthplace">Место рождения</label>
                                    <div class="col-md-9">
                                        <div class="ex-wrapper">
                                ...
                                <div class="form-group has-feedback row">
                                    <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end"
                                           for="city">Населённый пункт</label>
                                    <div class="col-md-9">
                                        <div class="ex-wrapper">
                            ...
                            data-validation-optional="true">
                                ...
                                <div class="form-group has-feedback row">
                                    <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end"
                                           for="reg_type">Тип регистрации</label>
                                    <div class="col-md-9">
                                        <div class="ex-wrapper ex-arrow">
