<div class="form-group has-feedback">
    <label class="control-label col-md-4 label-required">Серия и номер паспорта</label>
    <div class="col-md-6">
...
<div class="form-group has-feedback">
    <label class="control-label col-md-4 label-required">Дата выдачи</label>
    <div class="col-md-6">
        <div class="ex-wrapper">
...
<div class="form-group has-feedback">
    <label class="control-label label-required col-md-4" for="code">Код подразделения</label>
    <div class="col-md-6">
        <div class="ex-wrapper">
...
<div class="form-group has-feedback">
    <label class="control-label col-md-4 label-required">Кем выдан</label>
    <div class="col-md-6">
        <div class="ex-wrapper">
...
<div class="form-group has-feedback">
    <label class="control-label col-md-4 label-required">Место рождения</label>
    <div class="col-md-6">
        <div class="ex-wrapper">
...
<div class="form-group has-feedback">
    <label class="control-label col-md-4 label-required" for="corpus">Строение (корпус)</label>
    <div class="col-md-6">
        <div class="ex-wrapper">
...
<div class="form-group has-feedback">
    <label class="control-label col-md-4 label-required">Квартира</label>
    <div class="col-md-6">
        <div class="ex-wrapper">
...
<div class="form-group has-feedback">
    <label class="control-label col-md-4 label-required">Тип регистрации</label>
    <div class="col-md-6">
