...
function CheckTime() {
    ...
    if (withinRange) {
        ...
        $('#birthdate').parent().removeClass('has-error').addClass('has-success');
...
function CheckTime2() {
    ...
    if (withinRange) {
        ...
        $('#passportdate').parent().removeClass('has-error').addClass('has-success');
        ...
        $('#passportdate').parent().removeClass('has-success').addClass('has-error');
