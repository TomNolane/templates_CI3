...
<head>
    ...
    <!-- CSS -->
     <?php
     echo '<style>';
     require 'templates/zaimsoon/assets/css/bootstrap-theme.css';
     echo '</style>';
     echo '<style>';
