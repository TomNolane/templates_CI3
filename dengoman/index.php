...
<div class="container">
	...
	<div class="row">
					...
					<div class="form-slider green">
						<input type="text" class="amount" name="amount" value="30000" />
                                        ...
                                        <div class="col-md-12 info">
                                            <div class="col-md-6">
                                                <div class="btn form-info"><span class="form-info-title">К возврату</span><span class="form-info-data sum">6780Р</span></div>
                                                <div class="btn form-info"><span class="form-info-title">Процентная ставка</span><span class="form-info-data perc">1.3<span>%</span></span></div>                                                                                              
                                            </div>
                                            <div class="col-md-6">
                                                <div class="btn form-info"><span class="form-info-title">Комиссия</span><span class="form-info-data comm">780Р</span></div>                                                  
                                                <div class="btn form-info"><span class="form-info-title">Срок</span><span class="form-info-data d">От 61 до 130 дней</span></div>
                                            </div>
                                        </div>                                        
                                        <div class="col-md-12">
                                            <img id="ps" src="/templates/dengoman/img/index/ps.png">
                                        </div>
		...
		<div class="col-md-6 col-sm-5 hidden-xs">
			<img src="/templates/dengoman/img/index/man.png">
		</div>
				...
				<form id="anketa" action="/form" method="post">
					...
					<div class="form-slider green">
						<input type="text" class="amount" name="amount" value="30000" />
                                        ...
                                        <div class="col-md-12 info">
                                            <div class="col-md-6">
                                                <div class="btn form-info"><span class="form-info-title">К возврату</span><span class="form-info-data sum">33900Р</span></div>
                                                <div class="btn form-info"><span class="form-info-title">Комиссия</span><span class="form-info-data comm">3900Р</span></div>                                                
                                            </div>
                                            <div class="col-md-6">
                                                <div class="btn form-info"><span class="form-info-title">Процентная ставка</span><span class="form-info-data perc">1.3<span>%</span></span></div>                                                
                                                <div class="btn form-info"><span class="form-info-title">Срок</span><span class="form-info-data d">От 3 до 4 недель</span></div>
                                            </div>
                                        </div>                                        
					<button type="submit" class="btn">Получить деньги</button>                                        
				</form>
		...
		<div id="carousel-features" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active" id="slide-0">
						<div class="row">
							<div class="col-sm-4 text-center">
								<img src="/templates/dengoman/img/index/1.png">
								<p>Сайт доступен с любого<br>устройства</p>
								<p>Получите деньги со смартфона,<br>планшета или компьютера</p>
							</div>
							<div class="col-sm-4 text-center">
								<img src="/templates/dengoman/img/index/2.png">
								<p>Круглосуточная работа<br>&nbsp;</p>
								<p>Сервис работает 24x7, включая<br>праздники и выходные</p>
							</div>
							<div class="col-sm-4 text-center">
								<img src="/templates/dengoman/img/index/3.png">
								<p>Безопасность и<br>конфиденциальность</p>
								<p>Все ваши личные данные хранятся в<br>зашифрованном виде</p>
							</div>
						</div>
					</div>
					<div class="item" id="slide-1">
						<div class="row">
							<div class="col-sm-4 text-center">
								<img src="/templates/dengoman/img/index/4.png">
								<p>Перечисление на любой<br>счёт</p>
								<p>VISA, MASTER CARD, QIWI,<br>Яндекс.деньги, банковский счёт,<br>CONTACT</p>
							</div>
							<div class="col-sm-4 text-center">
								<img src="/templates/dengoman/img/index/5.png">
								<p>Доверие к нашим<br>клиентам</p>
								<p>Для постоянных клиентов<br>максимальная сумма займа<br>увеличивается</p>
							</div>
							<div class="col-sm-4 text-center">
								<img src="/templates/dengoman/img/index/6.png">
								<p>Займы доступны по всей<br>России</p>
								<p>Вы можете получить займ в любой<br>точке РФ. Все что Вам нужно - это<br>доступ к интернету</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-sm-12 text-center">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active" id="slide-0">
						<div class="row">
							<div class="col-sm-4 col-sm-offset-1 text-center">
								<img src="/templates/dengoman/img/reviews/1.jpg">
							</div>
							<div class="col-sm-5 col-md-offset-1">
								<h3>Светлана Бондарчик</h3>
								<p>Красноярск</p>
								<p><em>Добрый вечер! С благодарностью к компании. Огромное спасибо за понимание и участие!!! Всего самого хорошего и доброго Вам.</em></p>
					...
					<div class="item" id="slide-1">
						<div class="row">
							<div class="col-sm-4 col-sm-offset-1 text-center">
								<img src="/templates/dengoman/img/reviews/2.jpg">
							</div>
							<div class="col-sm-5 col-md-offset-1">
								<h3>Олег Ефимов</h3>
								<p>Воронеж</p>
								<p><em>Cпасибо этой компании,очень быстрое и качественное обслуживание!!!</em></p>
								<a class="btn carousel-button" href="/form">Получить деньги</a>
							</div>
						</div>
					</div>
					<div class="item" id="slide-2">
						<div class="row">
							<div class="col-sm-4 col-sm-offset-1 text-center">
								<img src="/templates/dengoman/img/reviews/3.jpg">
							</div>
							<div class="col-sm-5 col-md-offset-1">
								<h3>Валентина Никитина</h3>
								<p>Осташков</p>
								<p><em>Очень классная организация, деньги перевели быстро, отличный сервис!рекомендую!!!</em></p>
								<a class="btn carousel-button" href="/form">Получить деньги</a>
							</div>
						</div>
					</div>
					<div class="item" id="slide-3">
						<div class="row">
							<div class="col-sm-4 col-sm-offset-1 text-center">
								<img src="/templates/dengoman/img/reviews/4.jpg">
							</div>
							<div class="col-sm-5 col-md-offset-1">
								<h3>Александр Готфрид</h3>
								<p>Красноярск</p>
								<p><em>Я очень доволен пониманием и как здесь ценят клиентов</em></p>
								<a class="btn carousel-button" href="/form">Получить деньги</a>
							</div>
						</div>
					</div>
					<div class="item" id="slide-4">
						<div class="row">
							<div class="col-sm-4 col-sm-offset-1 text-center">
								<img src="/templates/dengoman/img/reviews/5.jpg">
							</div>
							<div class="col-sm-5 col-md-offset-1">
								<h3>Антон Казанцев</h3>
								<p>Назарово</p>
								<p><em>ОТ ДУШИ БЛАГОДАРЮ ВАС ЗА ТО,ЧТО ВЫРУЧИЛИ!ВАМ ПРОЦВЕТАНИЯ,А НАМ ЧТОБ ВО ВРЕМЯ ПЛАТИЛИ!</em></p>
								<a class="btn carousel-button" href="/form">Получить деньги</a>
							</div>
						</div>
					</div>
					<div class="item" id="slide-5">
						<div class="row">
							<div class="col-sm-4 col-sm-offset-1 text-center">
								<img src="/templates/dengoman/img/reviews/6.jpg">
							</div>
							<div class="col-sm-5 col-md-offset-1">
								<h3>Василий Шаров</h3>
								<p>Черкесск</p>
								<p><em>Хорошая быстрая компания ,компетентные сотрудники</em></p>
								<a class="btn carousel-button" href="/form">Получить деньги</a>
							</div>
						</div>
					</div>
...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-5 hidden-sm hidden-xs">
			<img src="/templates/dengoman/img/index/where.png" class="visible-lg">
		</div>
		<div class="col-md-7 col-xs-12">
			<div class="text">
				<p>Часто случается, что нужно быстро забронировать билеты или совершить неотложную покупку, но имеющиеся финансы совершенно не позволяют этого сделать. Конечно, можно занять до зарплаты у друзей или взять кредит в банке. Но как поступить, если средства необходимы здесь и сейчас?Часто случается, что нужно быстро забронировать билеты или совершить неотложную покупку, но имеющиеся финансы совершенно не позволяют этого сделать. Конечно, можно занять до зарплаты у друзей или взять кредит в банке. Но как поступить, если средства необходимы здесь и сейчас?</p>
				<p>Есть надежное решение — все активнее набирает свою популярность услуга предоставления жителям РФ небольших сумм денег на короткий срок. Такие займы можно оформить онлайн — именно поэтому все больше наших соотечественников обращаются к этому способу получения средств. При оформлении такого займа не приходится тратить время на посещение банковского офиса, сбор справок, поиск поручителей и долгое ожидание вердикта кредитных специалистов. Получение моментального займа онлайн любым жителем РФ — это простой и удобный инструмент решения финансовых вопросов. Заполните специальную форму прямо на сайте, и решение о выдаче необходимой суммы станет известно за считанные минуты.</p>
				<div class="text-center"><a href="/form" class="btn">Получить деньги</a></div>
			</div>
		</div>
	</div>
</div>
	            	...
	            	<div class="col-sm-12 great-support-box wow fadeInLeft">
	                    <div class="great-support-box-text great-support-box-text-left">
	                    	...
	                    	<p class="medium-paragraph">
                                    Dengoman — это один из лучших онлайн сервисов в РФ по подбору выгодных онлайн займов. 
                                    Сервис помогает людям в круглосуточном режиме, семь дней в неделю. 
	                    	</p>
	                    	<p>
                                    Главным преимуществом использования сервиса Dengoman является время. 
                                    Мы ценим ваше время и поэтому сервис максимально быстро подбирает вам условия и сроки займа. 
                                </p>
	                    	<p>
        ...
        <div class="call-to-action-container section-container section-container-image-bg">
	        <div class="container">
	            ...
	            <div class="row">
	            	<div class="col-sm-12 great-support-box wow fadeInLeft">
	                    <div class="great-support-box-text great-support-box-text-left">
                                <p class="medium-paragraph">Если вы взяли займ на сумму 50 000 рублей на 6 месяцев с процентной ставкой 4,5% в месяц, то после истечения срока займа переплата составит 13500 рублей. Получается вы возвращаете 63 500 рублей.</p>
        ...
        <!--div class="more-services-container section-container">
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 call-to-action section-description wow fadeInLeftBig">
	                    <h3>
                                Документы и разрешительная документация:
                            </h3>
	                </div>
	            </div>                    
	            <div class="row">
