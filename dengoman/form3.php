<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		<div class="shadow"><select class="form-control ec" id="work" name="work">
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
            <div class="shadow">
                <input type="text" class="form-control ec tip" value="ООО Завод" name="work_name" id="work_name" placeholder="Место работы" title="Укажите, ваше место работы" data-sanitize="capitalize"  data-validation="custom" data-validation-regexp='^[А-Яа-яЁё\d\s\-\,\№\#\.\+\(\)"]+$' data-validation-error-msg="Укажите, ваше место работы" required>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
            <div class="shadow">
                ...
                <span id="work_occupationstatus" value="электрик-монтажник" class="glyphicon form-control-feedback" aria-hidden="true"></span>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12"><div class="shadow">
                <input type="tel" class="form-control ec tip" value="8(912)123-45-67" name="work_phone" placeholder="Рабочий телефон" title="Укажите ваш рабочий телефон" id="work_phone" data-validation="custom" data-validation-regexp="^[8]\s\([0-9]{3}\)\s[0-9]{3}\s[0-9]{4}$" data-validation-error-msg="Укажите ваш рабочий телефон" data-validation-optional="true">
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-6">
            <div class="shadow">
                <input type="tel" class="form-control ec tip" value="12" name="work_experience" id="work_experience" placeholder="Стаж в месяцах" title="Укажите ваш стаж работы в месяцах" data-validation="number" data-validation-error-msg="Укажите ваш стаж работы в месяцах" required>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-6">
        <div class="shadow">
            <input type="tel" maxlength="6" value="25000" class="form-control ec tip" name="work_salary" id="work_salary" placeholder="Зарплата в рублях" title="Укажите вашу среднюю зарплату"  data-validation="number" data-validation-error-msg="Укажите среднюю зарплату" required>
...
<div class="form-group has-feedback">
	<label class="col-sm-4 control-label label-required hidden-xs">Город где работаете</label>
	<div class="col-sm-8 col-xs-12">
		<div class="shadow">
                    <input type="text" class="form-control ec tip" value="г. Новосибирск" name="work_city" placeholder="Город" title="Город где работаете" id="work_city" value="<?php echo isset($city_name)? $city_name : ''; ?>" data-sanitize="capitalize" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\-\.\(\)\s]+$" data-validation-error-msg="Укажите, населенный пункт" required>
...
<div class="form-group has-feedback">
	<label class="col-sm-4 control-label label-required hidden-xs">Улица работы</label>
	<div class="col-sm-8 col-xs-12">
            <div class="shadow">
                <input type="text" class="form-control ec tip" value="ул. Ленина" name="work_street" placeholder="Улица" title="Укажите улицу" id="work_street" data-sanitize="capitalize" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\d\s\-\,\#\.\+\(\)]+$" data-validation-error-msg="Укажите, улицу" required>
...
<div class="form-group has-feedback">
	<label class="col-sm-4 control-label label-required hidden-xs">Номер дома работы</label>
	<div class="col-sm-6">
            <div class="shadow">
                <input type="text" class="form-control ec tip" value="14" name="work_house" placeholder="Номер дома" title="Укажите номер дома работы" id="work_house"  data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Укажите, номер дома" required>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-6">
            <div class="shadow">
                <input type="text" class="form-control ec tip" value="1а" name="work_building" placeholder="Корпус" title="Укажите номер строения или корпуса" id="work_building"  data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Укажите, строение (корпус)" data-validation-optional="true">
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-6">
            <div class="shadow">
                <input type="text" class="form-control ec tip" value="108" name="work_office" placeholder="Номер офиса" title="Укажите номер офиса" id="work_office" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Укажите, номер офиса" data-validation-optional="true">
