...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12"><div class="shadow">
                <input type="tel" class="form-control ec tip" name="work_phone" placeholder="Рабочий телефон" title="Укажите ваш рабочий телефон" id="work_phone" data-validation="custom" data-validation-regexp="^[8]\s\([0-9]{3}\)\s[0-9]{3}\s[0-9]{4}$" data-validation-error-msg="Укажите ваш рабочий телефон" data-validation-optional="true">
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-6">
            <div class="shadow">
                <input type="tel" class="form-control ec tip"  name="work_experience" id="work_experience" placeholder="Стаж в месяцах" title="Укажите ваш стаж работы в месяцах" data-validation="number" data-validation-error-msg="Укажите ваш стаж работы в месяцах" required>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-6">
        <div class="shadow">
            <input type="tel" maxlength="6" class="form-control ec tip" name="work_salary" id="work_salary" placeholder="Зарплата в рублях" title="Укажите вашу среднюю зарплату"  data-validation="number" data-validation-error-msg="Укажите среднюю зарплату" required>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-8 col-xs-12">
		<div class="shadow">
                    <input type="text" class="form-control ec tip" name="work_city" placeholder="Город" title="Город где работаете" id="work_city" value="<?php echo isset($city_name)? $city_name : ''; ?>" data-sanitize="capitalize" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\-\.\(\)\s]+$" data-validation-error-msg="Укажите, населенный пункт" required>
...
<div class="form-group has-feedback">
	...
	<div class="col-sm-6">
            <div class="shadow">
                <input type="text" class="form-control ec tip" name="work_house" placeholder="Номер дома" title="Укажите номер дома работы" id="work_house"  data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Укажите, номер дома" required>
