...
<div class="page-about white">
  <p class="text-indent">
	«Dengoman» — это один из лучших онлайн сервисов в РФ по подбору выгодных онлайн займов. Мы объединили 35 микрофинансовых организаций с самыми лучшими кредитными предложениями. Сервис помогает людям в круглосуточном режиме, семь дней в неделю.
  </p>
  <p class="text-indent">
	Главным преимуществом использования сервиса Dengoman является время. Мы ценим ваше время и поэтому сервис максимально быстро подбирает вам условия и сроки займа.  Возможности Dengoman позволяют узнать Кредитную историю заемщика, а также ее улучшить если это необходимо.
  </p>
  ...
  <div class="about-steps hidden-xs">
	<p class="text-indent">Как получить онлайн займ с помощью Dengoman?</p>
	  ...
	  <div class="col-xs-8 col-xs-offset-2">
	    <div class="row">
	      <div class="col-xs-4 text-center">
		    <img src="/templates/dengoman/img/about/1.png">
		    <p>1. Выберите сумму и срок</p>
		  </div>
		  <div class="col-xs-4 text-center">
		    <img src="/templates/dengoman/img/about/2.png">
		    <p>2. Заполните анкету</p>
		  </div>
		  <div class="col-xs-4 text-center">
		    <img src="/templates/dengoman/img/about/3.png">
