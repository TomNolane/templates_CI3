...
if(!isset($description))
	$description = 'Zaimol - лучший онлайн сервис по выдаче мгновенных займов и кредитов без проверки вашей кредитной истории. Только у нас лучшие кредитные предложения!';
?>
...
<head>
	...
	<meta property="og:image" content="https://zaimol.ru/templates/zaimol/assets/img/about-bg.jpg"/>
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://zaimol.ru/" />

	<meta name="twitter:card" content="https://zaimol.ru/templates/zaimol/assets/img/about-bg.jpg"/>
	<meta name="twitter:title" content="Срочные займы круглосуточно без проверок Онлайн"/>
	<meta name="twitter:description" content="Zaimol - лучший онлайн сервис по выдаче мгновенных займов и кредитов без проверки вашей кредитной истории.Только у нас лучшие кредитные предложения!"/>
	<meta name="twitter:image:src" content="https://zaimol.ru/templates/zaimol/assets/img/about-bg.jpg"/>
	<meta name="twitter:url" content="https://zaimol.ru/"/>
	<meta name="twitter:domain" content="zaimol.ru"/>

	<!-- Favicons -->
	<link rel="apple-touch-icon" sizes="57x57" href="/templates/zaimol/favicon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="/templates/zaimol/favicon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/templates/zaimol/favicon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="/templates/zaimol/favicon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/templates/zaimol/favicon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="/templates/zaimol/favicon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="/templates/zaimol/favicon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="/templates/zaimol/favicon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="/templates/zaimol/favicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="/templates/zaimol/favicon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/templates/zaimol/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="/templates/zaimol/favicon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/templates/zaimol/favicon/favicon-16x16.png">
    <link rel="manifest" href="/templates/zaimol/favicon/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="/templates/zaimol/favicon/ms-icon-144x144.png">
	<meta name="theme-color" content="#ffffff">
	
	<?php 
		echo '<style>';
		require "templates/zaimol/assets/css/ion.rangeSlider.css"; 
		echo '</style>'; 
		echo '<style>'; 
		require "templates/zaimol/assets/css/ion.rangeSlider.skinHTML5.css"; 
		echo '</style>'; 
		...
		.tip-twitter .tip-arrow-top {
			...
			width:9px;
			height:5px;
			background:url(/templates/zaimol/assets/img/tip-twitter_arrows.gif) no-repeat;
		}
		.tip-twitter .tip-arrow-right {
			...
			width:5px;
			height:9px;
			background:url(/templates/zaimol/assets/img/tip-twitter_arrows.gif) no-repeat -9px 0;
		}
		.tip-twitter .tip-arrow-bottom {
			...
			width:9px;
			height:5px;
			background:url(/templates/zaimol/assets/img/tip-twitter_arrows.gif) no-repeat -18px 0;
		}
		.tip-twitter .tip-arrow-left {
			...
			width:5px;
			height:9px;
			background:url(/templates/zaimol/assets/img/tip-twitter_arrows.gif) no-repeat -27px 0;
		}
		'; 
		echo '</style>'; 
