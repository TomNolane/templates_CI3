...
$(document).ready(function () { 
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (validator.status) {
                    ...
                    $('#phone').removeClass('er').addClass('valid'); 
                    ...
                    $('#phonestatus').html('');
                    $('#phone').removeClass('valid').addClass('er'); 
    ...
    $('input').on('validation', function (evt, valid) {
        if(valid){
                if(this.name == 'f' || this.name == 'i' || this.name == 'o' || this.name == 'work_city' || this.name == 'city' || this.name == 'street' || this.name == 'work_name' || this.name == 'work_occupation' || this.name == 'work_city' || this.name == 'work_street' || this.name == 'birthplace')
                {
                    var  val = $(this).val();
                    $(this).val(val.charAt(0).toUpperCase() + val.substr(1));
                } 

                if(this.name == 'birthdate' && $('#birthdate').val().length <= 1) 
                {
                    $('#_birthdate').addClass('label_er').removeClass('label_true').removeClass('sign__word').addClass('sign__word__red');
                    $('#birthdate').removeClass('valid').addClass('er');
                    $('#birthdate').parent().removeClass('has-success').addClass('has-error');
                    $('#birthdatestatus').removeClass('glyphicon-ok').addClass('glyphicon-remove');
                    $('#birthdate').attr('placeholder',evt.currentTarget.dataset.validationErrorMsg);
                    return;
                }
                else
                {
                    $(this).parent().prev().removeClass('label_er').addClass('label_true').removeClass('sign__word__red').addClass('sign__word');
                }

                if(this.name == 'passport_code')
                {
                    $('#birthplace').focus();
                }
                
                
                if(this.name == 'passport_code') $('#passport_who').parent().prev().removeClass('label_er').addClass('label_true').removeClass('sign__word__red').addClass('sign__word');
                $(this).removeClass('er');
                ...
                {
                    $(this).parent().prev().addClass('label_er').removeClass('label_true').removeClass('sign__word').addClass('sign__word__red');
                    if(this.name == 'passport_code') $('#passport_who').parent().prev().addClass('label_er').removeClass('label_true').removeClass('sign__word').addClass('sign__word__red');
