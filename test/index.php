    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2 col-sm-2 col-md-offset-1 col-sm-offset-1">
                <div class="algo-item">
                    <a href="/form">
                        <img src="/templates/test/assets/img/steps/1.png" alt="1.png">
                    </a>
                </div>
                <p>Зайдите на сайт</p>
            </div>
            ...
            <div class="col-md-2 col-sm-2 text-center">
                <div class="algo-item">
                    <a href="/form">
                        <img src="/templates/test/assets/img/steps/2.png" alt="2.png">
                    </a>
                </div>
            ...
            <div class="col-md-2 col-sm-2 text-center">
                <div class="algo-item">
                    <a href="/form">
                        <img src="/templates/test/assets/img/steps/3.png" alt="3.png">
                    </a>
                </div>
                <p>Получите деньги</p>
            </div>
            ...
            <div class="col-xs-12 text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6">
                        <div class="algo-item">
                            <a href="/form">
                                <img src="/templates/test/assets/img/advantage/1.png" alt="1.png">
                            </a>
                        </div>
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6">
                        <div class="algo-item">
                            <a href="/form">
                                <img src="/templates/test/assets/img/advantage/2.png" alt="2.png">
                            </a>
                        </div>
                        <h3>Гибкость</h3>
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6">
                        <div class="algo-item">
                            <a href="/form">
                                <img src="/templates/test/assets/img/advantage/3.png" alt="3.png">
                            </a>
                        </div>
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6">
                        <div class="algo-item">
                            <a href="/form">
                                <img src="/templates/test/assets/img/advantage/4.png" alt="4.png">
                            </a>
                        </div>
                    ...
                    <div class="col-md-2 col-sm-6 col-xs-6">
                        <div class="algo-item">
                            <a href="/form">
                                <img src="/templates/test/assets/img/advantage/5.png" alt="5.png">
                            </a>
                        </div>
                        <h3>Большие суммы</h3>
        ...
        <div class="row">
            <div class="col-xs-12 text-center">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="algo-item">
                            <img src="/templates/test/assets/img/reviews/1.png" alt="1.png">
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="algo-item">
                            <img src="/templates/test/assets/img/reviews/2.png" alt="2.png">
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="algo-item">
                            <img src="/templates/test/assets/img/reviews/3.png" alt="3.png">
                        </div>
