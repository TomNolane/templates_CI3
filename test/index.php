            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-xs-2">
                            <div class="ex-img-block">
                                <img src="/templates/test/assets/img/diamond.png" alt="diamond.png" class="ex-vh-center">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-2">
                            <div class="ex-img-block">
                                <img src="/templates/test/assets/img/placeholder.png" alt="placeholder.png" class="ex-vh-center">
                            </div>
                        </div>
                        <div class="col-xs-10 special_index4">
                    ...
                    <div class="row">
                        <div class="col-xs-2">
                            <div class="ex-img-block">
                                <img src="/templates/test/assets/img/www.png" alt="www.png" class="ex-vh-center">
                            </div>
                        </div>
                        <div class="col-xs-10 special_index4">
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-xs-2">
                            <div class="ex-img-block">
                                <img src="/templates/test/assets/img/man.png" alt="man.png" class="ex-vh-center">
                            </div>
                        </div>
                        <div class="col-xs-10 special_index4">
                    ...
                    <div class="row">
                        <div class="col-xs-2">
                            <div class="ex-img-block">
                                <img src="/templates/test/assets/img/credit-story.png" alt="credit-story.png" class="ex-vh-center">
                            </div>
                        </div>
                        <div class="col-xs-10 special_index4">
                    ...
                    <div class="row">
                        <div class="col-xs-2">
                            <div class="ex-img-block">
                                <img src="/templates/test/assets/img/24h.png" alt="24h.png" class="ex-vh-center">
                            </div>
                        </div>
                        <div class="col-xs-10 special_index4">
                            <h3>Круглосуточно</h3>
                    ...
                    <a id="href" href="/credits">
                        <div class="ex-about-zaim-block">
                            <h4>Непосильные кредиты:
                                как не попасть<br>
                                в долговую яму</h4>
                            <img src="/templates/test/assets/img/1.jpg" alt="1.png">
                        </div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a id="href" href="/restructuring">
                        <div class="ex-about-zaim-block">
                            <h4>Реструктуризация
                                кредита</h4>
                            <img src="/templates/test/assets/img/2.jpg" alt="2.png">
                        </div>
                    </a>
                </div> 
                <div class="col-md-3 col-sm-6">
                    <a id="href" href="/refinancing">
                        ...
                        <img src="/templates/test/assets/img/3.jpg" alt="3.png">
                        </div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a id="href" href="/insolvency">
                        <div class="ex-about-zaim-block">
                            <h4>Банкротство<br>
                                физических лиц</h4> 
                            <img src="/templates/test/assets/img/4.jpg" alt="4.png">
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-5 col-xs-6 text-center">
                    <img src="/templates/test/assets/img/pic-email.png" alt="pic-email.png">
                </div>
