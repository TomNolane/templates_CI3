    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 hidden-xs hidden-sm visible-md visible-lg">
                ...
                <a href="/form"><img src="templates/test/assets/img/calc.png" alt="calc.png" class="ex-vh-center"></a>
                </div>
            </div>
            <div class="col-md-6 hidden-xs hidden-sm visible-md visible-lg">
        ...
        <div class="row">
            <div class="col-md-6 hidden-xs hidden-sm visible-md visible-lg">
                <div class="ex-get-money-block">
                   <a href="/form"> <img src="templates/test/assets/img/spasibo.png" alt="spasibo.png" class="ex-vh-center"></a>
                </div>
            </div>
            <div class="col-md-6 hidden-xs hidden-sm visible-md visible-lg">
                <div class="ex-get-money-steps">
        ...
        <div class="row">
            <div class="col-md-6 hidden-xs hidden-sm visible-md visible-lg">
                <div class="ex-get-money-block">
					<a href="/form"><img src="templates/test/assets/img/screen.png" alt="screen.png" class="ex-vh-center"></a>
                </div>
            </div>
            <div class="col-md-6 hidden-xs hidden-sm visible-md visible-lg">
                <div class="ex-get-money-steps">
