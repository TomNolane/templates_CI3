	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-5 col-sm-offset-2 hidden-xs hidden-sm">
				...
				<img src="/templates/test/assets/img/bank2.png" alt="rublimo.ru" id="bank">
			</div>
		...
		<div class="howto-body">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<a href="#calc">
							<img src="/templates/test/assets/img/howto.png" alt="rublimo.ru">
						</a>
						<div class="shadow">
					...
					<div class="col-sm-12">
						<div class="middle-cover">
							<div class="middle">
								...
								<img src="/templates/test/assets/img/howto/1.png" alt="Заполните анкету" class="pull-right">
							</div>
						</div>
					</div>
				</div>
						...
						<div class="middle-cover">
							<div class="middle">
								<div class="pull-left">2. Выберите сумму
									<br>и срок займа</div>
								<img src="/templates/test/assets/img/howto/2.png" alt="Выберите сумму" class="pull-right">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-12">
						<div class="middle-cover">
							<div class="middle">
								...
								<img src="/templates/test/assets/img/howto/3.png" alt="Получите деньги" class="pull-right">
							</div>
						</div>
					</div>
				</div>
	...
	<section class="rating hidden-md hidden-sm hidden-xs">
		<div class="container">
			<div class="row text-center">
				...
				<div class="col-sm-5">
					<img src="/templates/test/assets/img/man.png" alt="man">
				</div>
			</div>
		</div>
	</section>
