<div class="ex-anketa-head">
    <img src="/templates/test/assets/img/active1.png" alt="active1.png">
    <h2>
        Личные данные
    </h2>
</div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <a class="btn special_index5 special_form3 text-center" id="next1f">Далее <i class="fa fa-caret-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
